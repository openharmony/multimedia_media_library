...
const std::string GALLERY_SCALE_X = "face.scale_x";
const std::string GALLERY_SCALE_Y = "face.scale_y";
const std::string GALLERY_SCALE_WIDTH = "face.scale_width";
const std::string GALLERY_SCALE_HEIGHT = "face.scale_height";
const std::string GALLERY_PITCH = "face.pitch";
const std::string GALLERY_YAW = "face.yaw";
const std::string GALLERY_ROLL = "face.roll";
const std::string GALLERY_PROB = "face.prob";
const std::string GALLERY_TOTAL_FACE = "face.total_face";
const std::string GALLERY_LANDMARKS = "face.landmarks";
