...
const std::string GALLERY_TABLE_TAG = "tag";
...
const std::string GALLERY_CENTER_FEATURES = "tag.center_features";
...
const std::string GALLERY_IS_COVER = "merge_face.is_cover";
...
const std::string GALLERY_FEATURES = "face.features";
...
const std::string GALLERY_TAG_TAG_ID = GALLERY_TABLE_TAG + "." + GALLERY_TAG_ID;
...
const std::string GALLERY_PORTRAIT_ALBUM_TABLE = GALLERY_TABLE_MERGE_TAG + " INNER JOIN " + GALLERY_TABLE_TAG + " ON " +
    GALLERY_MERGE_TAG_TAG_ID + " = " + GALLERY_TAG_TAG_ID + " WHERE " + GALLERY_TAG_NAME_NOT_NULL_OR_EMPTY + " AND " +
...
const std::string GALLERY_FACE_TABLE_FULL = GALLERY_TABLE_MERGE_FACE + " INNER JOIN " + GALLERY_TABLE_FACE + " ON " +
    GALLERY_MERGE_FACE_HASH + " = " + GALLERY_FACE_HASH;
} // namespace Media
} // namespace OHOS
