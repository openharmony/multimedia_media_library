...
void DfxCollector::CollectInvalidKey(const std::string &bundleName, const std::string &sql)
{
...
void DfxCollector::CollectInvalidPrivateOpen(const std::string &bundleName, const std::string &operation)
{
...
void DfxCollector::CollectSpecialOpen(const std::string &bundleName, const std::string &operation)
{
