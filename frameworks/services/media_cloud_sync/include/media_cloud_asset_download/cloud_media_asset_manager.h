...
private:
    ...
    EXPORT vector<int> GetValuesAndBackup(const std::shared_ptr<NativeRdb::ResultSet>& resultSet);
    EXPORT string BuildEmptyAlbumsWhereClause(const std::vector<int>& albumIds);
private:
