...
static void GenerateCancelUpdateInternal(RdbPredicates &updatePredicates, ValuesBucket &rdbValues, 
    ...
    CloudEnhancementAvailableType type)
{
    ...
    GenerateCancelUpdateInternal(updatePredicates, rdbValues, fileIds);
