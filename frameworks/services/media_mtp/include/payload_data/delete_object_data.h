 ...
 */
#ifndef FRAMEWORKS_SERVICES_MEDIA_MTP_INCLUDE_DELETE_OBJECT_DATA_H_
#define FRAMEWORKS_SERVICES_MEDIA_MTP_INCLUDE_DELETE_OBJECT_DATA_H_
#include "mtp_constants.h"
#include "payload_data.h"
namespace OHOS {
namespace Media {
class DeleteObjectData : public PayloadData {
public:
...
#endif  // FRAMEWORKS_SERVICES_MEDIA_MTP_INCLUDE_DELETE_OBJECT_DATA_H_
