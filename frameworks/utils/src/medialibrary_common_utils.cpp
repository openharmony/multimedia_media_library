...
static const std::unordered_set<std::string> FILE_KEY_WHITE_LIST {
    ...
    CONST_MEDIA_DATA_DB_DATE_ADDED_S,
    CONST_MEDIA_DATA_DB_DATE_MODIFIED,
    CONST_MEDIA_DATA_DB_DATE_MODIFIED_S,
    CONST_MEDIA_DATA_DB_DATE_TAKEN,
    CONST_MEDIA_DATA_DB_DATE_TAKEN_S,
    ...
    CONST_MEDIA_DATA_DB_DATE_TRASHED_S,
    CONST_MEDIA_DATA_DB_BUCKET_ID,
    CONST_MEDIA_DATA_DB_ALBUM_ID,
    ...
    CONST_MEDIA_DATA_DB_OWNER_PACKAGE,
    ...
    CONST_MEDIA_DATA_DB_ALL_EXIF,
    CONST_MEDIA_DATA_DB_SHOOTING_MODE,
    CONST_MEDIA_DATA_DB_SHOOTING_MODE_TAG,
    CONST_MEDIA_DATA_DB_PHOTOS_LATITUDE,
    CONST_MEDIA_DATA_DB_PHOTOS_LONGITUDE,
    CONST_MEDIA_DATA_DB_USER_OPERATION,
    ...
    CONST_COMPAT_HIDDEN,
    CONST_COMPAT_PHOTO_SYNC_STATUS,
    CONST_COMPAT_FILE_SUBTYPE,
    CONST_COMPAT_CAMERA_SHOT_KEY,

    // PhotoAlbum table columns
    CONST_COMPAT_ALBUM_SUBTYPE,
    ALBUM_LPATH,
    ALBUM_BUNDLE_NAME,
