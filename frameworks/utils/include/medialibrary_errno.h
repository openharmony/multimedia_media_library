...
constexpr int32_t E_ACQ_BETA_TASK_FAIL   =  MEDIA_LIBRARY_ERR(E_COMMON_OFFSET, 39);
constexpr int32_t E_OPR_DEBUG_DB_FAIL    =  MEDIA_LIBRARY_ERR(E_COMMON_OFFSET, 40);
...
constexpr int32_t E_READ_CLOUD_PERMISSION_CHECK = MEDIA_LIBRARY_ERR(E_COMMON_OFFSET, 64);
constexpr int32_t E_SCENE_PARAM_INVALID =   MEDIA_LIBRARY_ERR(E_COMMON_OFFSET, 57);
constexpr int32_t E_SCENE_HAS_DELETED =     MEDIA_LIBRARY_ERR(E_COMMON_OFFSET, 58);
constexpr int32_t E_SCENE_IS_HIDDEN   =     MEDIA_LIBRARY_ERR(E_COMMON_OFFSET, 59);
constexpr int32_t E_SCENE_IS_CLOUD    =     MEDIA_LIBRARY_ERR(E_COMMON_OFFSET, 60);
constexpr int32_t E_SCENE_ALBUM_NOT_EXIST = MEDIA_LIBRARY_ERR(E_COMMON_OFFSET, 61);
constexpr int32_t E_SCENE_NO_ENOUGH_SPACE = MEDIA_LIBRARY_ERR(E_COMMON_OFFSET, 62);
constexpr int32_t E_SCENE_HAS_RENAMED  =    MEDIA_LIBRARY_ERR(E_COMMON_OFFSET, 63);
constexpr int32_t E_SCENE_HAS_CANCEL  =     MEDIA_LIBRARY_ERR(E_COMMON_OFFSET, 64);
constexpr int32_t E_SET_SHARE_ALBUM_NAME_DB_FAIL = MEDIA_LIBRARY_ERR(E_COMMON_OFFSET, 65);
constexpr int32_t E_SHARE_ALBUM_INVALID_ID_ARG = MEDIA_LIBRARY_ERR(E_COMMON_OFFSET, 66);
constexpr int32_t E_SHARE_ALBUM_NOT_SUPPORT_PARAM_INVALID = MEDIA_LIBRARY_ERR(E_COMMON_OFFSET, 67);
constexpr int32_t E_SHARE_ASSET_NOT_SUPPORT_PARAM_ERR = MEDIA_LIBRARY_ERR(E_COMMON_OFFSET, 68);
...
constexpr int32_t E_RDB_UPDATE_NO_ROWS_CHANGED = MEDIA_LIBRARY_ERR(E_THUMBNAIL_OFFSET, 12);
constexpr int32_t E_RDB_QUERY_NO_RES = MEDIA_LIBRARY_ERR(E_THUMBNAIL_OFFSET, 13);
...
// media File Management error code { 19000, 19099}
constexpr int32_t E_MEDIA_FILE_MANAGEMENT_OFFSET = 19000;
constexpr int32_t E_INVALID_PARAM = MEDIA_LIBRARY_ERR(E_MEDIA_FILE_MANAGEMENT_OFFSET, 0);
constexpr int32_t E_PATH_NOT_SUPPORT = MEDIA_LIBRARY_ERR(E_MEDIA_FILE_MANAGEMENT_OFFSET, 1);
constexpr int32_t E_FILE_NOT_EXIST = MEDIA_LIBRARY_ERR(E_MEDIA_FILE_MANAGEMENT_OFFSET, 2);
constexpr int32_t E_RENAME = MEDIA_LIBRARY_ERR(E_MEDIA_FILE_MANAGEMENT_OFFSET, 3);
constexpr int32_t E_MEDIA_TYPE_INVAILD = MEDIA_LIBRARY_ERR(E_MEDIA_FILE_MANAGEMENT_OFFSET, 4);
constexpr int32_t E_CANCEL_TASK = MEDIA_LIBRARY_ERR(E_MEDIA_FILE_MANAGEMENT_OFFSET, 5);
constexpr int32_t E_TARGET_ALBUM_INVAILD = MEDIA_LIBRARY_ERR(E_MEDIA_FILE_MANAGEMENT_OFFSET, 6);
constexpr int32_t E_FILE_HIDDEN_OR_TRASHED = MEDIA_LIBRARY_ERR(E_MEDIA_FILE_MANAGEMENT_OFFSET, 7);
constexpr int32_t E_FILE_IS_PENDING_STATU = MEDIA_LIBRARY_ERR(E_MEDIA_FILE_MANAGEMENT_OFFSET, 8);
constexpr int32_t E_FILE_OPEN_FAIL = MEDIA_LIBRARY_ERR(E_MEDIA_FILE_MANAGEMENT_OFFSET, 9);
