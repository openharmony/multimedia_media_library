...
#define ANALYSIS_ALBUM_MAX_VALUE_LENGTH 8192
#define ANALYSIS_ALBUM_MAX_NICK_NAME_COUNT 100
#define ANALYSIS_ALBUM_ATTR_EXTRA_INFO "extra_info"
#define ANALYSIS_ALBUM_MAX_EXTRA_INFO_COUNT 1
#define ANALYSIS_ALBUM_ATTR_FRIEND_ID "friend_id"
#define ANALYSIS_ALBUM_MAX_FRIEND_ID_COUNT 1
#define ANALYSIS_ALBUM_ATTR_CONTACT_INFO "contact_info"
#define ANALYSIS_ALBUM_MAX_CONTACT_INFO_COUNT 1
