...
const map<int32_t, struct HighlightAlbumInfo> GetHighlightAlbumInfoMap()
{
    static const map<int32_t, struct HighlightAlbumInfo> HIGHLIGHT_ALBUM_INFO_MAP = {
        { COVER_INFO, { CONST_PAH_QUERY_HIGHLIGHT_COVER, { ID, HIGHLIGHT_ALBUM_TABLE + "." +
            PhotoAlbumColumns::ALBUM_ID, AI_ALBUM_ID, SUB_TITLE, CLUSTER_TYPE, CLUSTER_SUB_TYPE,
        ...
        { ALBUM_INFO, { CONST_PAH_QUERY_HIGHLIGHT_ALBUM, { ID, HIGHLIGHT_ALBUM_TABLE + "." +
            PhotoAlbumColumns::ALBUM_ID, HIGHLIGHT_STATUS, HIGHLIGHT_IS_VIEWED, HIGHLIGHT_NOTIFICATION_TIME } } },
    };
