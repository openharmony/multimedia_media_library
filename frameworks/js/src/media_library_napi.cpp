...
static void GetResultDataExecute(napi_env env, void *data)
{
    ...
    shared_ptr<DataShareResultSet> resultSet = UserFileClient::Query(uri, sharePredicates, columns);
                                          ...
                                          MediaLibraryAsyncContext *context)
{
    ...
    int albumId = UserFileClient::Insert(createAlbumUri,
                                          ...
                                          MediaLibraryAsyncContext *context)
{
    ...
    Uri deleteAlbumUri(abilityUri + "/" + MEDIA_ALBUMOPRN + "/" + MEDIA_ALBUMOPRN_DELETEALBUM + "/" +
        to_string(albumId));
    int retVal = UserFileClient::Delete(deleteAlbumUri, {});
    if (retVal < 0) {
