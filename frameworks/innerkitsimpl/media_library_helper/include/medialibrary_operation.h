...
inline const std::map<std::string, OperationObject> OPRN_OBJ_MAP = {
    // use in Insert...
...
inline const std::map<OperationObject, std::map<OperationType, std::string>> TABLE_NAME_MAP = {
...
inline const std::map<std::string, OperationType> OPRN_TYPE_MAP = {
