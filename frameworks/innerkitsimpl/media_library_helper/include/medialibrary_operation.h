...
enum class EXPORT OperationObject : uint32_t {
    ...
    VISION_HEAD,
    VISION_AFFECTIVE,
    VISION_DEDUP_SELECTION,
    VISION_PROFILE,
    VISION_POSE,
    VISION_PET_FACE,
    VISION_PET_TAG,
    VISION_WATERMARK,
    VISION_END = VISION_WATERMARK,
    GEO_DICTIONARY,
    GEO_KNOWLEDGE,
    GEO_PHOTO,
    CONVERT_PHOTO,
