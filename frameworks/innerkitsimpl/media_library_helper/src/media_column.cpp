...
const std::string PhotoColumn::PHOTO_SHPT_ClEAN_FLAG_INDEX = "idx_shpt_clean_flag";
...
const std::string PhotoColumn::CREATE_SHPT_ClEAN_FLAG_INDEX = BaseColumn::CreateIndex() +
    PHOTO_SHPT_ClEAN_FLAG_INDEX + " ON " + PHOTOS_TABLE +
