...
#ifndef OHOS_MEDIA_CLOUD_SYNC_CLOUD_MEDIA_THREAD_LIMITER_H
#define OHOS_MEDIA_CLOUD_SYNC_CLOUD_MEDIA_THREAD_LIMITER_H
...
public:
    ...
    static std::shared_mutex DATA_CLIENT_READ_WRITE_MUTEX_;
};
...
#define CLOUD_DATA_CLIENT_WRITE_LOCK \
    std::unique_lock<std::shared_mutex> dataClientWriteLock(CloudMediaThreadLimiter::DATA_CLIENT_READ_WRITE_MUTEX_)
}  // namespace OHOS::Media::CloudSync
