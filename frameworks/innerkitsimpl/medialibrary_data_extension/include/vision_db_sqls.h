...
const std::string CREATE_TAB_ANALYSIS_PROGRESS = "CREATE TABLE IF NOT EXISTS " + TAB_ANALYSIS_PROGRESS_TABLE + " (" +
    SEARCH_FINISH_CNT + " INT DEFAULT 0, " +
    LOCATION_FINISH_CNT + " INT DEFAULT 0, " +
    FACE_FINISH_CNT + " INT DEFAULT 0, " +
    OBJECT_FINISH_CNT + " INT DEFAULT 0, " +
    AESTHETIC_FINISH_CNT + " INT DEFAULT 0, " +
    OCR_FINISH_CNT + " INT DEFAULT 0, " +
    POSE_FINISH_CNT + " INT DEFAULT 0, " +
    SALIENCY_FINISH_CNT + " INT DEFAULT 0, " +
    RECOMMENDATION_FINISH_CNT + " INT DEFAULT 0, " +
    SEGMENTATION_FINISH_CNT + " INT DEFAULT 0, " +
    BEAUTY_AESTHETIC_FINISH_CNT + " INT DEFAULT 0, " +
    HEAD_DETECT_FINISH_CNT + " INT DEFAULT 0, " +
    LABEL_DETECT_FINISH_CNT + " INT DEFAULT 0, " +
    TOTAL_IMAGE_CNT + " INT DEFAULT 0, " +
    FULLY_ANALYZED_IMAGE_CNT + " INT DEFAULT 0, " +
