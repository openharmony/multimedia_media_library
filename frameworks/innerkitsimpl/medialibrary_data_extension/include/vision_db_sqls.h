...
const std::string CREATE_TAB_ANALYSIS_AESTHETICS = "CREATE TABLE IF NOT EXISTS " + VISION_AESTHETICS_TABLE + " (" +
    ...
    AESTHETICS_SCORE_ALL + " INT, " +
    IS_FILTERED_HARD + " BOOLEAN, " +
    CLARITY_SCORE_ALL + " DOUBLE, " +
    SATURATION_SCORE_ALL + " DOUBLE, " +
    LUMINANCE_SCORE_ALL + " DOUBLE, " +
    SEMANTICS_SCORE + " DOUBLE, " +
    IS_BLACK_WHITE_STRIPE + " BOOLEAN, " +
    IS_BLURRY + " BOOLEAN, " +
    IS_MOSAIC + " BOOLEAN)";
...
const std::string CREATE_TAB_ANALYSIS_TOTAL_FOR_ONCREATE = "CREATE TABLE IF NOT EXISTS " + VISION_TOTAL_TABLE + " (" +
    ...
    POSE + " INT, " +
    GEO + " INT DEFAULT 0, " +
    AESTHETICS_SCORE_ALL_STATUS + " INT, " +
