...
private:
    ...
    MediaLibraryUnistoreManager(const MediaLibraryUnistoreManager &obj) = delete;
    MediaLibraryUnistoreManager &operator=(const MediaLibraryUnistoreManager &obj) = delete;
