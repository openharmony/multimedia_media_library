...
const std::vector<AlbumPluginRowData> ALBUM_PLUGIN_DATA = {
    ...
    {"/CtripMedia/shortcut", "携程旅行", "CtripMedia", "", "", "", 0},
    ...
    {"/DCIM/mgtv", "芒果tv", "mgtv", "com.imgo.pad", "", "", 0},
    ...
    {"/Pictures/qqmusic/lyricposter", "QQ音乐", "QQMusic", "com.tencent.hm.qqmusic", "", "", 0},
    ...
    {"/DCIM", "DCIM", "DCIM", "", "", ""},
    {"/DCIM/CA_IMAGES", "Creators'APP", "Creators'APP", "", "", ""},
    {"/DCIM/Duolingo", "多邻国", "多邻国", "com.duolingo", "", ""},
    ...
    {"/DCIM/WeixinWork", "企业微信", "企业微信", "com.tencent.wework", "", ""},
    {"/DCIM/blued", "Blued", "Blued", "com.soft.blued", "", "", 0},
    {"/DCIM/com.baidu.newapp", "文小言", "文小言", "", "", ""},
    {"/DCIM/com.uu898.uuhavequality", "悠悠有品", "悠悠有品", "com.uu898.uuhavequality", "", ""},
    {"/DCIM/miaojian", "秒剪", "秒剪", "com.tencent.phoenix", "", ""},
    {"/DCIM/pipixia", "皮皮虾", "皮皮虾", "com.sup.android.superb", "", ""},
    {"/DCIM/soul", "Soul", "Soul", "cn.soulapp.android", "", ""},
    {"/DCIM/tblive", "点淘", "点淘", "", "", ""},
    {"/DCIM/tieba", "百度贴吧", "百度贴吧", "com.baidu.tieba", "", "", 0},
    {"/DCIM/王者营地", "王者营地", "王者营地", "com.tencent.gamehelper.smoba", "", ""},
    {"/DCIM/移动办公", "中移移动办公", "中移移动办公", "com.cmri.ercs.yqx", "", ""},
    {"/Download/UCDownloads/share", "UC浏览器", "UC浏览器", "", "", ""},
    {"/Download/一刻相册", "一刻相册", "一刻相册", "com.baidu.youavideo", "", ""},
    {"/ESedited/VideoEdit", "美颜相机", "美颜相机", "com.meitu.meiyancamera", "", "", 0},
    {"/JinJiangReader/晋江小说阅读", "晋江小说阅读", "晋江小说阅读", "", "", ""},
    {"/Movies", "Movies", "Movies", "", "", ""},
    {"/Movies/baidu/searchbox/downloads", "百度", "baidu", "com.baidu.searchbox", "", ""},
    {"/Movies/soul", "Soul", "Soul", "cn.soulapp.android", "", "", 0},
    {"/Movies/英雄联盟手游精彩时刻", "英雄联盟手游", "英雄联盟手游", "com.tencent.lolm", "", ""},
    {"/Pictures/Buff", "网易BUFF", "网易BUFF", "com.netease.buff", "", ""},
    {"/Pictures/ButterPicture", "黄油相机", "ButterPicture", "com.by.butter.camera", "", "", 0},
    {"/Pictures/DeepSpace", "恋与深空", "DeepSpace", "com.papegames.lysk.cn", "", ""},
    {"/Pictures/MailMaster", "网易邮箱", "MailMaster", "com.netease.mobimail", "", ""},
    {"/Pictures/TapTap", "TapTap", "TapTap", "com.taptap", "", ""},
    {"/Pictures/XF", "小方", "小方", "com.foundersc.app.xf", "", ""},
    {"/Pictures/blued", "Blued", "Blued", "com.soft.blued", "", ""},
    {"/Pictures/douyin/comment", "抖音", "douyin", "com.ss.android.ugc.aweme", "", "", 0},
    {"/Pictures/finapplet", "易捷加油", "易捷加油", "cn.com.hkgt.gasapp", "", ""},
    {"/Pictures/gifshow", "快手", "快手", "", "", ""},
    {"/Pictures/hello", "哈啰", "哈啰", "com.jingyao.easybike", "", ""},
    {"/Pictures/nebula", "快手极速版", "快手极速版", "com.kuaishou.nebula", "", ""},
    {"/Pictures/polarr", "泼辣修图", "polarr", "photo.editor.polarr", "", ""},
    {"/Pictures/xiaopeng", "小鹏汽车", "xiaopeng", "com.xiaopeng.mycarinfo", "", ""},
    {"/Snapseed", "Snapseed", "Snapseed", "com.snapseedpro.ymapp", "", ""},
    {"/DCIM/画世界Pro", "画世界Pro", "画世界Pro", "net.huanci.hsjpro", "", ""},
    {"/DCIM/QDReader", "起点读书", "QDReader", "com.qidian.qdreader", "", ""}
};
} // namespace AlbumPlugin
