...
void MediaLibraryCommand::ParseOprnTypeFromUri()
{
    ...
    const static map<string, OperationType> oprnTypeMap = {
        {MEDIA_FILEOPRN_CLOSEASSET, CLOSE},         {MEDIA_FILEOPRN_CREATEASSET, CREATE},
        {MEDIA_ALBUMOPRN_CREATEALBUM, CREATE},      {MEDIA_FILEOPRN_DELETEASSET, DELETE},
        {MEDIA_ALBUMOPRN_DELETEALBUM, DELETE},      {MEDIA_FILEOPRN_MODIFYASSET, UPDATE},
        {MEDIA_ALBUMOPRN_MODIFYALBUM, UPDATE},      {MEDIA_ALBUMOPRN_QUERYALBUM, QUERY},
        {MEDIA_FILEOPRN_ISDIRECTORY, ISDICTIONARY}, {MEDIA_FILEOPRN_GETALBUMCAPACITY, QUERY}};
