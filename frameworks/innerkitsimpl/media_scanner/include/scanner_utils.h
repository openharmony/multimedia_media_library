...
static const std::unordered_map<std::string, std::string> SUPPORTED_EXTN_MAP = {
    ...
    {IMAGE_CONTAINER_TYPE_BMP, "image/bmp"},
    {IMAGE_CONTAINER_TYPE_BM, "image/bmp"},
    {IMAGE_CONTAINER_TYPE_GIF, "image/gif"},
    {IMAGE_CONTAINER_TYPE_JPG, "image/jpeg"},
    {IMAGE_CONTAINER_TYPE_JPEG, "image/jpeg"},
    {IMAGE_CONTAINER_TYPE_JPE, "image/jpeg"},
    {IMAGE_CONTAINER_TYPE_PNG, "image/png"},
