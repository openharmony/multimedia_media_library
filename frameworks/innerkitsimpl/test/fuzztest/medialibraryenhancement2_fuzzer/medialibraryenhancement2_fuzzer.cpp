...
#include "medialibraryenhancement2_fuzzer.h"
...
static void SetCompositeDisplayMode(int32_t fileId, int32_t compositeDisplayMode)
{
    Media::AssetChangeReqBody reqBody;
    ...
    MessageParcel reply;
    auto service = make_shared<Media::MediaAssetsControllerService>();
...
static void EnhancementManagerExtraTest()
{
    ...
    SetCompositeDisplayMode(testFileId, provider->ConsumeIntegral<int32_t>());
...
static void EnhancementServiceAdpterTest()
{
    ...
    vector<string> taskIdList = {provider->ConsumeBytesAsString(NUM_BYTES)};
