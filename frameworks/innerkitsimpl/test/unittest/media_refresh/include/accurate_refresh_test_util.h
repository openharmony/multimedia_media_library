...
const int32_t DEFAULT_IS_COVER_SATISFIED = -1;
const std::string DEFAULT_GROUP_TAG = "";
...
const int32_t FAVORITE_IS_COVER_SATISFIED = -1;
const std::string FAVORITE_GROUP_TAG = "";
...
const AlbumChangeInfo FAVORITE_ALBUM_INFO = {
    ...
    FAVORITE_IS_COVER_SATISFIED, FAVORITE_GROUP_TAG, FAVORITE_ALBUM_HIDDEN
};
...
const int32_t TRASH_IS_COVER_SATISFIED = -1;
const std::string TRASH_GROUP_TAG = "";
...
const AlbumChangeInfo TRASH_ALBUM_INFO = {
    ...
    static_cast<int32_t>(DirtyType::TYPE_NEW), TRASH_ALBUMS_ORDER, TRASH_ORDER_SECTION, TRASH_IS_COVER_SATISFIED,
    TRASH_GROUP_TAG, TRASH_ALBUM_HIDDEN
};
...
const int32_t HIDDEN_IS_COVER_SATISFIED = -1;
const std::string HIDDEN_GROUP_TAG = "";
...
const AlbumChangeInfo HIDDEN_ALBUM_INFO = {
    ...
    static_cast<int32_t>(DirtyType::TYPE_NEW), HIDDEN_ALBUMS_ORDER, HIDDEN_ORDER_SECTION, HIDDEN_IS_COVER_SATISFIED,
    HIDDEN_GROUP_TAG, HIDDEN_ALBUM_HIDDEN
};
...
const AlbumChangeInfo VIDEO_ALBUM_INFO = {
    ...
    static_cast<int32_t>(DirtyType::TYPE_NEW), VIDEO_ALBUMS_ORDER, VIDEO_ORDER_SECTION, DEFAULT_IS_COVER_SATISFIED,
    DEFAULT_GROUP_TAG, VIDEO_ALBUM_HIDDEN
};
...
const AlbumChangeInfo IMAGE_ALBUM_INFO = {
    ...
    static_cast<int32_t>(DirtyType::TYPE_NEW), IMAGE_ALBUMS_ORDER, IMAGE_ORDER_SECTION, DEFAULT_IS_COVER_SATISFIED,
    DEFAULT_GROUP_TAG, IMAGE_ALBUM_HIDDEN
};
...
const AlbumChangeInfo CLOUD_ENHANCEMENT_ALBUM_INFO = {
    ...
    DEFAULT_IS_COVER_SATISFIED, DEFAULT_GROUP_TAG, CLOUD_ENHANCEMENT_ALBUM_HIDDEN
};
...
const AlbumChangeInfo USER_ALBUM_INFO = {
    ...
    DEFAULT_IS_COVER_SATISFIED, DEFAULT_GROUP_TAG, USER_ALBUM_HIDDEN
};
...
const AlbumChangeInfo SOURCE_ALBUM_INFO = {
    ...
    DEFAULT_IS_COVER_SATISFIED, DEFAULT_GROUP_TAG, SOURCE_ALBUM_HIDDEN
};
