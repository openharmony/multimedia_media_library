...
const AlbumChangeInfo FAVORITE_ALBUM_INFO = {
    ...
    static_cast<int32_t>(DirtyType::TYPE_NEW), FAVORITE_ALBUMS_ORDER, FAVORITE_ORDER_SECTION
};
...
const AlbumChangeInfo TRASH_ALBUM_INFO = {
    ...
    static_cast<int32_t>(DirtyType::TYPE_NEW), TRASH_ALBUMS_ORDER, TRASH_ORDER_SECTION
};
...
const AlbumChangeInfo HIDDEN_ALBUM_INFO = {
    ...
    static_cast<int32_t>(DirtyType::TYPE_NEW), HIDDEN_ALBUMS_ORDER, HIDDEN_ORDER_SECTION
};
...
const AlbumChangeInfo VIDEO_ALBUM_INFO = {
    ...
    static_cast<int32_t>(DirtyType::TYPE_NEW), VIDEO_ALBUMS_ORDER, VIDEO_ORDER_SECTION
};
...
const AlbumChangeInfo IMAGE_ALBUM_INFO = {
    ...
    static_cast<int32_t>(DirtyType::TYPE_NEW), IMAGE_ALBUMS_ORDER, IMAGE_ORDER_SECTION
};
