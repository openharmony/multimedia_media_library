...
const std::string FAVORITE_ALBUM_COVER_URI = "TRASH_coverUri";
const int32_t FAVORITE_ALBUM_HIDDEN_COUNT = 4444;
const std::string FAVORITE_ALBUM_HIDDEN_COVER_URI = "favorite_hiddenCoverUri";
...
const std::string TRASH_ALBUM_COVER_URI = "TRASH_coverUri";
const int32_t TRASH_ALBUM_HIDDEN_COUNT = 4;
const std::string TRASH_ALBUM_HIDDEN_COVER_URI = "TRASH_hiddenCoverUri";
...
const std::string HIDDEN_ALBUM_COVER_URI = "HIDDEN_coverUri";
const int32_t HIDDEN_ALBUM_HIDDEN_COUNT = 44;
const std::string HIDDEN_ALBUM_HIDDEN_COVER_URI = "HIDDEN_hiddenCoverUri";
...
const std::string VIDEO_ALBUM_COVER_URI = "VIDEO_coverUri";
const int32_t VIDEO_ALBUM_HIDDEN_COUNT = 4;
const std::string VIDEO_ALBUM_HIDDEN_COVER_URI = "VIDEO_hiddenCoverUri";
...
const std::string IMAGE_ALBUM_COVER_URI = "IMAGE_coverUri";
const int32_t IMAGE_ALBUM_HIDDEN_COUNT = 4;
const std::string IMAGE_ALBUM_HIDDEN_COVER_URI = "IMAGE_hiddenCoverUri";
...
const std::string CLOUD_ENHANCEMENT_ALBUM_COVER_URI = "CLOUD_ENHANCEMENT_coverUri";
const int32_t CLOUD_ENHANCEMENT_ALBUM_HIDDEN_COUNT = 4;
const std::string CLOUD_ENHANCEMENT_ALBUM_HIDDEN_COVER_URI = "CLOUD_ENHANCEMENT_hiddenCoverUri";
...
const std::string USER_ALBUM_COVER_URI = "USER_coverUri";
const int32_t USER_ALBUM_HIDDEN_COUNT = 4;
const std::string USER_ALBUM_HIDDEN_COVER_URI = "USER_hiddenCoverUri";
...
const std::string SOURCE_ALBUM_COVER_URI = "SOURCE_coverUri";
const int32_t SOURCE_ALBUM_HIDDEN_COUNT = 4;
const std::string SOURCE_ALBUM_HIDDEN_COVER_URI = "SOURCE_hiddenCoverUri";
