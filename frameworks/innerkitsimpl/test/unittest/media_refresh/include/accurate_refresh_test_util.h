...
const int64_t FAVORITE_ALBUM_ORDER = -1;
...
const AlbumChangeInfo FAVORITE_ALBUM_INFO = {
    ...
    static_cast<int32_t>(DirtyType::TYPE_NEW), FAVORITE_ALBUM_ORDER, FAVORITE_ORDER_SECTION
};
...
const int64_t TRASH_ALBUM_ORDER = -1;
...
const AlbumChangeInfo TRASH_ALBUM_INFO = {
    ...
    static_cast<int32_t>(DirtyType::TYPE_NEW), TRASH_ALBUM_ORDER, TRASH_ORDER_SECTION
};
...
const int64_t HIDDEN_ALBUM_ORDER = -1;
...
const AlbumChangeInfo HIDDEN_ALBUM_INFO = {
    ...
    static_cast<int32_t>(DirtyType::TYPE_NEW), HIDDEN_ALBUM_ORDER, HIDDEN_ORDER_SECTION
};
...
const int64_t VIDEO_ALBUM_ORDER = -1;
...
const AlbumChangeInfo VIDEO_ALBUM_INFO = {
    ...
    static_cast<int32_t>(DirtyType::TYPE_NEW), VIDEO_ALBUM_ORDER, VIDEO_ORDER_SECTION
};
...
const int64_t IMAGE_ALBUM_ORDER = -1;
...
const AlbumChangeInfo IMAGE_ALBUM_INFO = {
    ...
    static_cast<int32_t>(DirtyType::TYPE_NEW), IMAGE_ALBUM_ORDER, IMAGE_ORDER_SECTION
};
...
const int64_t CLOUD_ENHANCEMENT_ALBUM_ORDER = -1;
...
const AlbumChangeInfo CLOUD_ENHANCEMENT_ALBUM_INFO = {
    ...
    static_cast<int32_t>(DirtyType::TYPE_NEW), CLOUD_ENHANCEMENT_ALBUM_ORDER, CLOUD_ENHANCEMENT_ORDER_SECTION
};
...
const int64_t USER_ALBUM_ALBUM_ORDER = -1;
...
const AlbumChangeInfo USER_ALBUM_INFO = {
    ...
    static_cast<int32_t>(DirtyType::TYPE_NEW), USER_ALBUM_ALBUM_ORDER, USER_ALBUM_ORDER_SECTION
};
...
const int64_t SOURCE_ALBUM_ALBUM_ORDER = -1;
...
const AlbumChangeInfo SOURCE_ALBUM_INFO = {
    ...
    static_cast<int32_t>(DirtyType::TYPE_NEW), SOURCE_ALBUM_ALBUM_ORDER, SOURCE_ALBUM_ORDER_SECTION
};
