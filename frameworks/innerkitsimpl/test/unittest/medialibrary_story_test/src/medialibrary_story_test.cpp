...
HWTEST_F(MediaLibraryStoryTest, Story_InsertAlbum_Test_001, TestSize.Level0)
{
    ...
    valuesBucket.Put(SHARE_COVER_COUNT, 6);
    valuesBucket.Put(RENAME_COUNT, 7);
    valuesBucket.Put(CHANGE_COVER_COUNT, 7);
    valuesBucket.Put(RENDER_VIEWED_TIMES, 5);
    valuesBucket.Put(RENDER_VIEWED_DURATION, 5);
    valuesBucket.Put(ART_LAYOUT_VIEWED_TIMES, 6);
    valuesBucket.Put(ART_LAYOUT_VIEWED_DURATION, 6);
...
HWTEST_F(MediaLibraryStoryTest, Story_InsertPlayInfo_Test_001, TestSize.Level0)
{
    ...
    valuesBucket.Put(PLAY_INFO, "file://media/Photo/1/1/2.jpg");
