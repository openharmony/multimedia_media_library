...
public:
    ...
    void InsertFaceTag(std::shared_ptr<NativeRdb::RdbStore> rdbPtr);
    void InsertImageFace(std::shared_ptr<NativeRdb::RdbStore> rdbPtr);
    
public:
    std::shared_ptr<NativeRdb::RdbStore> cloneStorePtr_;
};

class PortraitAlbumOpenCall : public NativeRdb::RdbOpenCallback {
public:
