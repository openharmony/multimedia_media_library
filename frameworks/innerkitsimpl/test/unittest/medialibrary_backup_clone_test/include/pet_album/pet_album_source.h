...
#ifndef PET_ALBUM_SOURCE_H
#define PET_ALBUM_SOURCE_H
...
public:
    ...
    void InsertPetTag(std::shared_ptr<NativeRdb::RdbStore> rdbPtr);
    void InsertPetFace(std::shared_ptr<NativeRdb::RdbStore> rdbPtr);
    
public:
    std::shared_ptr<NativeRdb::RdbStore> cloneStorePtr_;
};

class PetAlbumOpenCall : public NativeRdb::RdbOpenCallback {
public:
