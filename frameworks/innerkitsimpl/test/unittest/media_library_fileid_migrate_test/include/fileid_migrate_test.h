...
#ifndef FILEID_MIGRATE_TEST_H
#define FILEID_MIGRATE_TEST_H
...
class FileIdMigrateTest : public testing::Test {
public:
...
protected:
    ...
    // Helper to create tab_highlight_cover_info table
    int32_t CreateHighlightCoverTable(std::shared_ptr<NativeRdb::RdbStore> store);
 
    // Helper to create analysis tables
    int32_t CreateAnalysisTables(std::shared_ptr<NativeRdb::RdbStore> store);
    ...
    static constexpr const char* FILEID_OLD_DB = "fileid_old.db";
    static constexpr const char* FILEID_NEW_DB = "fileid_new.db";
};
 
} // namespace Media
} // namespace OHOS
 
#endif // FILEID_MIGRATE_TEST_H
