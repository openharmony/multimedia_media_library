...
#ifndef OHOS_MEDIA_CLOUD_SYNC_CLOUD_MEDIA_PHOTO_HANDLER_TEST_H
#define OHOS_MEDIA_CLOUD_SYNC_CLOUD_MEDIA_PHOTO_HANDLER_TEST_H
...
class CloudMediaPhotoHandlerTest : public testing::Test {
public:
...
public:
    static std::vector<TableMockInfo> GetTableMockInfoList()
    {
        ...
        photosTableMockInfo.csvFilePath = "/data/test/cloudsync/photo_handler-photos.csv";
        ...
        photoAlbumTableMockInfo.csvFilePath = "/data/test/cloudsync/photo_handler-photo_album.csv";
...
#endif  // OHOS_MEDIA_CLOUD_SYNC_CLOUD_MEDIA_PHOTO_HANDLER_TEST_H
