...
#ifndef OHOS_MEDIA_CLOUD_SYNC_CLOUD_MEDIA_PHOTO_ALBUM_HANDLER_TEST_H
#define OHOS_MEDIA_CLOUD_SYNC_CLOUD_MEDIA_PHOTO_ALBUM_HANDLER_TEST_H
...
class CloudMediaPhotoAlbumHandlerTest : public testing::Test {
public:
...
public:
    static std::vector<TableMockInfo> GetTableMockInfoList()
    {
        ...
        photosTableMockInfo.csvFilePath = "/data/test/cloudsync/photo_album_handler-photos.csv";
        ...
        photoAlbumTableMockInfo.csvFilePath = "/data/test/cloudsync/photo_album_handler-photo_album.csv";
...
#endif  // OHOS_MEDIA_CLOUD_SYNC_CLOUD_MEDIA_PHOTO_ALBUM_HANDLER_TEST_H
