...
#ifndef OHOS_MEDIA_CLOUD_SYNC_CLOUD_MEDIA_ALBUM_HANDLER_ONFETCHRECORDS_TEST_H
#define OHOS_MEDIA_CLOUD_SYNC_CLOUD_MEDIA_ALBUM_HANDLER_ONFETCHRECORDS_TEST_H
...
class CloudMediaAlbumHandlerOnFetchRecordsTest : public testing::Test {
public:
...
public:
    static std::vector<TableMockInfo> GetTableMockInfoList()
    {
        ...
        photosTableMockInfo.csvFilePath = "/data/test/cloudsync/albumhandler/onfetchrecords_photo.csv";
        ...
        photoAlbumTableMockInfo.csvFilePath = "/data/test/cloudsync/albumhandler/onfetchrecords_album.csv";
...
private:
    ...
    static int32_t otherAlbumDirty_;
    static int32_t hiddenAlbumDirty_;
};
}  // namespace OHOS::Media::CloudSync
#endif  // OHOS_MEDIA_CLOUD_SYNC_CLOUD_MEDIA_ALBUM_HANDLER_ONFETCHRECORDS_TEST_H
