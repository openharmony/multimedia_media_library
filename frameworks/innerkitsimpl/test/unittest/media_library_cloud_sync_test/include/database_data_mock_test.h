...
#ifndef OHOS_MEDIA_CLOUD_SYNC_DATABASE_MOCK_TEST_H
#define OHOS_MEDIA_CLOUD_SYNC_DATABASE_MOCK_TEST_H
...
class DatabaseDataMockTest : public testing::Test {
public:
...
public:
    static std::vector<TableMockInfo> GetTableMockInfoList()
    {
        ...
        photosTableMockInfo.csvFilePath = "/data/test/cloudsync/database_mock-photos.csv";
        ...
        photoAlbumTableMockInfo.csvFilePath = "/data/test/cloudsync/database_mock-photo_album.csv";
...
#endif  // OHOS_MEDIA_CLOUD_SYNC_DATABASE_MOCK_TEST_H
