...
#ifndef OHOS_MEDIA_CLOUD_SYNC_CLOUD_MEDIA_PHOTO_HANDLER_ON_COPY_RECORDS_TEST_H
#define OHOS_MEDIA_CLOUD_SYNC_CLOUD_MEDIA_PHOTO_HANDLER_ON_COPY_RECORDS_TEST_H
...
class CloudMediaPhotoHandlerOnCopyRecordsTest : public testing::Test {
public:
...
public:
    static std::vector<TableMockInfo> GetTableMockInfoList()
    {
        ...
        photosTableMockInfo.csvFilePath = "/data/test/cloudsync/oncopyrecords_photo/oncopyrecord_photo.csv";
        ...
        photoAlbumTableMockInfo.csvFilePath = "/data/test/cloudsync/oncopyrecords_photo/oncopyrecord_album.csv";
...
#endif  // OHOS_MEDIA_CLOUD_SYNC_CLOUD_MEDIA_PHOTO_HANDLER_ON_COPY_RECORDS_TEST_H
