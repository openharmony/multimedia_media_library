...
#ifndef OHOS_MEDIA_CLOUD_SYNC_CLOUD_MEDIA_PHOTO_HANDLER_ON_CREATE_RECORDS_TEST_H
#define OHOS_MEDIA_CLOUD_SYNC_CLOUD_MEDIA_PHOTO_HANDLER_ON_CREATE_RECORDS_TEST_H
...
class CloudMediaPhotoHandlerOnCreateRecordsTest : public testing::Test {
public:
...
public:
    static std::vector<TableMockInfo> GetTableMockInfoList()
    {
        ...
        photosTableMockInfo.csvFilePath = "/data/test/cloudsync/photohandler/oncreatedrecords_photos.csv";
        ...
        photoAlbumTableMockInfo.csvFilePath = "/data/test/cloudsync/photohandler/oncreatedrecords_photo_album.csv";
...
#endif  // OHOS_MEDIA_CLOUD_SYNC_CLOUD_MEDIA_PHOTO_HANDLER_ON_CREATE_RECORDS_TEST_H
