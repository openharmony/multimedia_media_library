...
#ifndef OHOS_MEDIA_CLOUD_SYNC_CLOUD_MEDIA_DATA_CLIENT_TEST_H
#define OHOS_MEDIA_CLOUD_SYNC_CLOUD_MEDIA_DATA_CLIENT_TEST_H
...
class CloudMediaDataClientTest : public testing::Test {
public:
...
public:
    static std::vector<TableMockInfo> GetTableMockInfoList()
    {
        ...
        photosTableMockInfo.csvFilePath = "/data/test/cloudsync/data_client-photos.csv";
        ...
        photoAlbumTableMockInfo.csvFilePath = "/data/test/cloudsync/data_client-photo_album.csv";
...
#endif  // OHOS_MEDIA_CLOUD_SYNC_CLOUD_MEDIA_DATA_CLIENT_TEST_H
