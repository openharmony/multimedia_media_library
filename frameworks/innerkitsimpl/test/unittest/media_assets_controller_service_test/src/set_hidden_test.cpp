...
void SetHiddenTest::SetUpTestCase(void)
{
...
void SetHiddenTest::TearDownTestCase(void)
{
    ClearTable(PhotoColumn::PHOTOS_TABLE);
...
void SetHiddenTest::SetUp()
{
    MEDIA_INFO_LOG("SetUp");
}

void SetHiddenTest::TearDown(void)
{
...
static int32_t SetHidden(const string& uri, bool hidden)
{
...
HWTEST_F(SetHiddenTest, SetHiddenTest_Test_001, TestSize.Level0)
{
    MEDIA_INFO_LOG("Start SetHiddenTest_Test_001");
    // 1、前置条件准备，插入一张照片
    ...
    int32_t ret = SetHidden(largeString, true);
    ...
    changedRows = SetHidden(uri, false);
    EXPECT_GT(changedRows, 0);
