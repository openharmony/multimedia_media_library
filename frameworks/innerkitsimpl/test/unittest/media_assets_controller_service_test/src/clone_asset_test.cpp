...
void CloneAssetTest::SetUpTestCase(void)
{
...
void CloneAssetTest::TearDownTestCase(void)
{
...
void CloneAssetTest::SetUp()
{
    MEDIA_INFO_LOG("SetUp");
    ClearPhotosTables();
}

void CloneAssetTest::TearDown(void)
{
...
HWTEST_F(CloneAssetTest, CloneAsset_Test_002, TestSize.Level0)
{
    ...
    ASSERT_EQ(isValid, true);
    fileId = resp.GetErrCode();
    EXPECT_EQ(fileId, E_INVALID_VALUES);
    MEDIA_INFO_LOG("End CloneAsset_Test_002");
}
}  // namespace OHOS::Media