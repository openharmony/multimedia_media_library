...
HWTEST_F(MediaLibraryMTPUnitTest, medialibrary_MTP_message_testlevel0_010, TestSize.Level0)
{
    ...
    static std::vector<uint8_t> testData_1 = { 0x0C, 0x00, 0x00, 0x00, 0x01,
        0x00, 0x04, 0x10, 0x21, 0x00, 0x00, 0x00 };
    // set test data
    mtpTest->setOutBuffer(testData_1);
    // execute
    operationPtr_->Execute();
    // MTP_OPERATION_GET_STORAGE_INFO_CODE
    static std::vector<uint8_t> testData = { 0x10, 0x00, 0x00, 0x00, 0x01,
        0x00, 0x05, 0x10, 0x8C, 0x07, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00 };
    mtpTest->setOutBuffer(testData);
    // execute
    operationPtr_->Execute();
    // get output
...
HWTEST_F(MediaLibraryMTPUnitTest, medialibrary_MTP_message_testlevel0_011, TestSize.Level0)
{
    ...
    // MTP_OPERATION_GET_STORAGE_INFO_CODE
    static std::vector<uint8_t> testData_2 = { 0x10, 0x00, 0x00, 0x00, 0x01,
        0x00, 0x05, 0x10, 0x8C, 0x07, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00 };
...
HWTEST_F(MediaLibraryMTPUnitTest, medialibrary_MTP_message_testlevel0_020, TestSize.Level0)
{
    ...
    static std::vector<uint8_t> testData = { 0x10, 0x00, 0x00, 0x00, 0x01, 0x00, 0x08, 0x10,
        0x5c, 0x01, 0x00, 0x00, 0x10, 0x00, 0x00, 0x00 };
    mtpTest->setOutBuffer(testData);
    operationPtr_->Execute();
...
HWTEST_F(MediaLibraryMTPUnitTest, medialibrary_MTP_message_testlevel0_021, TestSize.Level0)
{
    ...
    static std::vector<uint8_t> testData = { 0x10, 0x00, 0x00, 0x00, 0x01, 0x00, 0x09, 0x10,
        0x5f, 0x01, 0x00, 0x00, 0x0b, 0x00, 0x00, 0x00 };
    mtpTest->setOutBuffer(testData);
    operationPtr_->Execute();
...
HWTEST_F(MediaLibraryMTPUnitTest, medialibrary_MTP_message_testlevel0_022, TestSize.Level0)
{
    ...
    // MTP_OPERATION_GET_STORAGE_INFO_CODE
    static std::vector<uint8_t> testData_2 = { 0x10, 0x00, 0x00, 0x00, 0x01, 0x00, 0x05, 0x10,
        0x8C, 0x07, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00 };
    mtpTest->setOutBuffer(testData_2);
    // execute
    operationPtr_->Execute();
    ...
    static std::vector<uint8_t> testData = { 0x10, 0x00, 0x00, 0x00, 0x01, 0x00, 0x0a,
        0x10, 0x71, 0x01, 0x00, 0x00, 0x03, 0x00, 0x00, 0x00 };
    mtpTest->setOutBuffer(testData);
    operationPtr_->Execute();
...
HWTEST_F(MediaLibraryMTPUnitTest, medialibrary_MTP_message_testlevel0_023, TestSize.Level0)
{
    std::shared_ptr<OHOS::Media::MtpTest> mtpTest = OHOS::Media::MtpTest::GetInstance();
    std::shared_ptr<MtpOperation> operationPtr_;
    OHOS::Media::MtpManager &manager = OHOS::Media::MtpManager::GetInstance();
    OHOS::Media::MtpManager::MtpMode mode = OHOS::Media::MtpManager::MtpMode::MTP_MODE;
    manager.StartMtpService(mode);
    if (operationPtr_ == nullptr) {
        operationPtr_ = make_shared<MtpOperation>();
    }
...
HWTEST_F(MediaLibraryMTPUnitTest, medialibrary_MTP_message_testlevel0_026, TestSize.Level0)
{
    ...
    // MTP_OPERATION_GET_OBJECT_PROP_LIST_CODE
    static std::vector<uint8_t> testData = { 0x20, 0x00, 0x00, 0x00, 0x01, 0x00, 0x05, 0x98, 0x40, 0x00,
        0x00, 0x00, 0x89, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xDC, 0x00, 0x00, 0x00, 0x00,
 ...
 */
HWTEST_F(MediaLibraryMTPUnitTest, medialibrary_MTP_message_testlevel0_033, TestSize.Level0)
{
    std::shared_ptr<OHOS::Media::MtpTest> mtpTest = OHOS::Media::MtpTest::GetInstance();
    std::shared_ptr<MtpOperation> operationPtr_;
    if (operationPtr_ == nullptr) {
