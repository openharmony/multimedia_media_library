...
void AlbumRecoverAssetsTest::SetUpTestCase(void)
{
    ...
    MEDIA_INFO_LOG("AlbumRecoverAssetsTest SetUpTestCase");
}
...
void AlbumRecoverAssetsTest::TearDownTestCase(void)
{
    ...
    MEDIA_INFO_LOG("AlbumRecoverAssetsTest TearDownTestCase");
...
void AlbumRecoverAssetsTest::SetUp()
{
    ...
    MEDIA_INFO_LOG("AlbumRecoverAssetsTest SetUp");
}
...
// {"albumType": "1024","albumSubType": "1028",
// "uris": " [file://media/Photo/5/IMG_1748424853_004/IMG_20250528_171337.jpg]}
