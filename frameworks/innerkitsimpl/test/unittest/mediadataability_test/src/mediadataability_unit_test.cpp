...
// }
// HWTEST_F(MediaDataAbilityUnitTest, MediaDataAbility_CreateSmartAlbum_Test_001, TestSize.Level0)
// {
//     string abilityUri = Media::MEDIALIBRARY_SMARTALBUM_URI;
//     Uri createAlbumUri(abilityUri + "/" + Media::MEDIA_SMARTALBUMOPRN + "/" + Media::MEDIA_SMARTALBUMOPRN_CREATEALBUM);
//     NativeRdb::ValuesBucket valuesBucket;
//     valuesBucket.PutString(SMARTALBUM_DB_NAME, "laoxu");
//     g_albumId1 = g_rdbStoreTest.Insert(createAlbumUri, valuesBucket);
//     EXPECT_NE((g_albumId1 <= 0), true);
// }
// HWTEST_F(MediaDataAbilityUnitTest, MediaDataAbility_CreateSmartAlbumMap_Test_001, TestSize.Level0)
// {
//     string abilityUri = Media::MEDIALIBRARY_SMARTALBUM_MAP_URI;
//     Uri createAlbumUri(abilityUri + "/" + Media::MEDIA_SMARTALBUMMAPOPRN + "/" + Media::MEDIA_SMARTALBUMMAPOPRN_ADDSMARTALBUM);
//     NativeRdb::ValuesBucket valuesBucket;
//     valuesBucket.PutInt(SMARTALBUMMAP_DB_ALBUM_ID, 0);
//     valuesBucket.PutInt(SMARTALBUMMAP_DB_ASSET_ID, 1);
//     g_albumId1 = g_rdbStoreTest.Insert(createAlbumUri, valuesBucket);
//     EXPECT_NE((g_albumId1 <= 0), true);
// }
// HWTEST_F(MediaDataAbilityUnitTest, MediaDataAbility_CreateSmartAlbumMap_Test_002, TestSize.Level0)
// {
//     string abilityUri = Media::MEDIALIBRARY_SMARTALBUM_MAP_URI;
//     Uri createAlbumUri(abilityUri + "/" + Media::MEDIA_SMARTALBUMMAPOPRN + "/" + Media::MEDIA_SMARTALBUMMAPOPRN_ADDSMARTALBUM);
//     NativeRdb::ValuesBucket valuesBucket;
//     valuesBucket.PutInt(SMARTALBUMMAP_DB_ALBUM_ID, 1);
//     valuesBucket.PutInt(SMARTALBUMMAP_DB_ASSET_ID, 2);
//     g_albumId1 = g_rdbStoreTest.Insert(createAlbumUri, valuesBucket);
//     EXPECT_NE((g_albumId1 <= 0), true);
// }
// HWTEST_F(MediaDataAbilityUnitTest, MediaDataAbility_CreateSmartAlbumMap_Test_003, TestSize.Level0)
// {
//     string abilityUri = Media::MEDIALIBRARY_SMARTALBUM_MAP_URI;
//     Uri createAlbumUri(abilityUri + "/" + Media::MEDIA_SMARTALBUMMAPOPRN + "/" + Media::MEDIA_SMARTALBUMMAPOPRN_ADDSMARTALBUM);
//     NativeRdb::ValuesBucket valuesBucket;
//     valuesBucket.PutInt(SMARTALBUMMAP_DB_ALBUM_ID, 2);
//     valuesBucket.PutInt(SMARTALBUMMAP_DB_ASSET_ID, 3);
//     g_albumId1 = g_rdbStoreTest.Insert(createAlbumUri, valuesBucket);
//     EXPECT_NE((g_albumId1 <= 0), true);
// }
...
//     valuesBucket.PutString(MEDIA_DATA_DB_BUCKET_NAME, albumName);
...
//     ret = g_resultSet2->GetColumnIndex(MEDIA_DATA_DB_BUCKET_NAME, columnIndex);
//     EXPECT_EQ(ret, NativeRdb::E_OK);
...
//     ret = g_resultSet3->GetColumnIndex(MEDIA_DATA_DB_BUCKET_NAME, columnIndex);
//     EXPECT_EQ(ret, NativeRdb::E_OK);
//     ret = g_resultSet3->GetString(columnIndex, strVal);
//     EXPECT_EQ(ret, NativeRdb::E_OK);
//     EXPECT_EQ("gtest_modified_album001", strVal);
...
//     EXPECT_EQ("new-modify", strVal);
// }
// HWTEST_F(MediaDataAbilityUnitTest, MediaDataAbilityQueryTest_006, TestSize.Level0)
// {
//     int32_t ret = -1;
//     NativeRdb::DataAbilityPredicates predicates1;
//     std::vector<std::string> columns = {SMARTALBUMMAP_DB_ID, SMARTALBUMMAP_DB_ALBUM_ID, SMARTALBUMMAP_DB_ASSET_ID};
//     Uri uri(MEDIALIBRARY_SMARTALBUM_MAP_URI+"/1");
//     std::shared_ptr<NativeRdb::AbsSharedResultSet> resultSet;
//     resultSet = g_rdbStoreTest.Query(uri, columns, predicates1);
//     EXPECT_NE(resultSet, nullptr);
...
//     int32_t intValAsset;
//     std::string strVal;
//     ret = resultSet->GetColumnIndex(SMARTALBUMMAP_DB_ALBUM_ID, columnIndex);
//     EXPECT_EQ(ret, NativeRdb::E_OK);

//     ret = resultSet->GetInt(columnIndex, intValAlbum);
//     EXPECT_EQ(ret, NativeRdb::E_OK);
//     EXPECT_EQ(1, intValAlbum);

//     ret = resultSet->GetColumnIndex(SMARTALBUMMAP_DB_ASSET_ID, columnIndex);
//     EXPECT_EQ(ret, NativeRdb::E_OK);
//     ret = resultSet->GetInt(columnIndex, intValAsset);
//     EXPECT_EQ(ret, NativeRdb::E_OK);
//     EXPECT_EQ(2, intValAsset);
// }
...
HWTEST_F(MediaDataAbilityUnitTest, MediaDataAbility_CreateAsset_Test_003, TestSize.Level0)
{
    ...
    string displayName = "gtest_new_file_0101.jpg";
    MediaType mediaType = MEDIA_TYPE_IMAGE;
    valuesBucket.PutInt(MEDIA_DATA_DB_MEDIA_TYPE, mediaType);
    valuesBucket.PutString(MEDIA_DATA_DB_NAME, displayName);
    valuesBucket.PutString(MEDIA_DATA_DB_RELATIVE_PATH, relativePath);
...
HWTEST_F(MediaDataAbilityUnitTest, MediaDataAbility_CreateAsset_Test_004, TestSize.Level0)
{
    ...
    Uri createAssetUri(abilityUri + "/" + Media::MEDIA_FILEOPRN + "/" + Media::MEDIA_FILEOPRN_CREATEASSET);
    NativeRdb::ValuesBucket valuesBucket;
    string relativePath = "test/createAsset/file02";
    string displayName = "gtest_new_file0102.jpg";
    MediaType mediaType = MEDIA_TYPE_IMAGE;
    valuesBucket.PutInt(MEDIA_DATA_DB_MEDIA_TYPE, mediaType);
    valuesBucket.PutString(MEDIA_DATA_DB_NAME, displayName);
    valuesBucket.PutString(MEDIA_DATA_DB_RELATIVE_PATH, relativePath);
...
HWTEST_F(MediaDataAbilityUnitTest, MediaDataAbility_GetAlbum_Test_001, TestSize.Level0)
{
    ...
    queryPredicates.EqualTo(MEDIA_DATA_DB_BUCKET_ID, std::to_string(10));
    ...
    valuesBucket1.PutString(MEDIA_DATA_DB_TITLE, "hello");
    predicates2.EqualTo(MEDIA_DATA_DB_ID, std::to_string(4));
    Uri uri(MEDIALIBRARY_DATA_URI);
    ...
    fileValuesBucket.PutString(MEDIA_DATA_DB_BUCKET_NAME, "hello");
    filePredicates.EqualTo(MEDIA_DATA_DB_BUCKET_ID, std::to_string(4));
