...
HWTEST_F(MediaLibraryPhotoOperationsTest, photo_oprn_query_api10_test_005, TestSize.Level0)
{
    ...
    MediaLibraryCommand cmd_hide(OperationObject::FILESYSTEM_PHOTO, OperationType::HIDE,
        MediaLibraryApi::API_10);
    ValuesBucket values_hide;
    SetValuesBucketInUpdate(MediaColumn::MEDIA_HIDDEN, "1", values_hide);
    cmd_hide.SetValueBucket(values_hide);
    cmd_hide.GetAbsRdbPredicates()->EqualTo(PhotoColumn::MEDIA_ID, to_string(fileId1));
    ...
    MediaLibraryCommand cmd_unhide(OperationObject::FILESYSTEM_PHOTO, OperationType::HIDE,
        MediaLibraryApi::API_10);
    ValuesBucket values_unhide;
    SetValuesBucketInUpdate(MediaColumn::MEDIA_HIDDEN, "0", values_unhide);
    cmd_unhide.SetValueBucket(values_unhide);
    cmd_unhide.GetAbsRdbPredicates()->EqualTo(PhotoColumn::MEDIA_ID, to_string(fileId1));
