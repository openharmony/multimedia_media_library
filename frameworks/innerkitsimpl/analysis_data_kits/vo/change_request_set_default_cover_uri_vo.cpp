...
#define MLOG_TAG "MediaChangeRequestSetDefaultCoverUriVo"
...
using namespace std;
bool ChangeRequestSetDefaultCoverUriReqBody::Unmarshalling(MessageParcel &parcel)
{
...
bool ChangeRequestSetDefaultCoverUriReqBody::Marshalling(MessageParcel &parcel) const
{
