 ...
 */
#ifndef DISTRIBUTED_DEVICES_BATCH_RECYCLE_EXECUTOR_H
#define DISTRIBUTED_DEVICES_BATCH_RECYCLE_EXECUTOR_H
#include <map>
#include <vector>
...
namespace OHOS {
namespace Media {
class DistributedDevicesBatchRecycleExecutor : public PolicyExecutor {
public:
...
#endif // DISTRIBUTED_DEVICES_BATCH_RECYCLE_EXECUTOR_H
