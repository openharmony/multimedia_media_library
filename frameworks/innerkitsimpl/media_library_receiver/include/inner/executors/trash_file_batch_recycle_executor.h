 ...
 */
#ifndef TRASH_FILE_BATCH_RECYCLE_EXECUTOR_H
#define TRASH_FILE_BATCH_RECYCLE_EXECUTOR_H
#include <map>
#include <vector>
...
namespace OHOS {
namespace Media {
class TrashFileBatchRecycleExecutor : public PolicyExecutor {
public:
...
#endif // TRASH_FILE_BATCH_RECYCLE_EXECUTOR_H
