 ...
 */
#ifndef EMPTY_FOLDER_BATCH_RECYCLE_EXECUTOR_H
#define EMPTY_FOLDER_BATCH_RECYCLE_EXECUTOR_H
#include <map>
#include <vector>
...
namespace OHOS {
namespace Media {
class EmptyFolderBatchRecycleExecutor : public PolicyExecutor {
public:
...
#endif // EMPTY_FOLDER_BATCH_RECYCLE_EXECUTOR_H
