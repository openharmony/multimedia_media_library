 ...
 */
#ifndef THUMBNAIL_BATCH_RECYCLE_EXECUTOR_H
#define THUMBNAIL_BATCH_RECYCLE_EXECUTOR_H
#include <map>
#include <vector>
...
namespace OHOS {
namespace Media {
class ThumbnailBatchRecycleExecutor : public PolicyExecutor {
public:
...
#endif // THUMBNAIL_BATCH_RECYCLE_EXECUTOR_H
