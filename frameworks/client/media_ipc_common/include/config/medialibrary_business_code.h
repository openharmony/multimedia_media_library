...
enum class MediaLibraryBusinessCode : uint32_t {
    ...
    START_BATCH_DOWNLOAD_CLOUD_RESOURCES,
    RESUME_BATCH_DOWNLOAD_CLOUD_RESOURCES,
    PAUSE_BATCH_DOWNLOAD_CLOUD_RESOURCES,
    CANCEL_BATCH_DOWNLOAD_CLOUD_RESOURCES,
    QUERY_GET_CLOUDMEDIA_BATCH_RESOURCES_STATUS,
    QUERY_GET_CLOUDMEDIA_BATCH_RESOURCES_COUNT,
    ACQUIRE_DEBUG_DATABASE,
    RELEASE_DEBUG_DATABASE,
    ASSET_CHANGE_SUBMIT_CACHE_FOR_PICKER,
    SLOW_MOTION_TRANSCODE,
    SLOW_MOTION_TRANSCODE_PROGRESS,
    CANCEL_SLOW_MOTION_TRANSCODE,
    CONVERT_FORMAT_MIME_TYPE,
    PAH_QUERY_FUSION_ASSET_INFO,
    ASSET_CHANGE_DELETE_LOCAL_ASSETS_WITH_URI,
    ASSET_CHANGE_DELETE_CLOUD_ASSETS_WITH_URI,
    LOG_CINEMATIC_VIDEO,
    SET_NETWORK_POLICY_FOR_BATCH_DOWNLOAD, // reserve
    QUERY_GET_CLOUDMEDIA_BATCH_RESOURCES_SIZE, // reserve
    DELETE_ASSETS_PERMANENTLY_WITH_URI,
    QUERY_MEDIA_DATA_STATUS,
    SET_APPLINK_STATE,
    CHECK_SINGLE_PHOTO_CHANGE_PERMISSION,
    SET_LIVEPHOTO_4D_STATUS,
    SET_COMPATIBLE_INFO,
    GET_COMPATIBLE_INFO,
    SET_PREFERRED_COMPATIBLE_MODE,
    GET_PREFERRED_COMPATIBLE_MODE,
    START_ACTIVE_ANALYSIS,
    STOP_ACTIVE_ANALYSIS,
    PAH_CHECK_PHOTO_URIS_READ_PERMISSION,
    SET_MOVING_PHOTO_VERSION,
    GET_TRANSCODE_CHECK_INFO,
    PAH_SYSTEM_CREATE_ASSET_WITH_ALBUM,
    START_DEEP_OPTIMIZE_SPACE,
    STOP_DEEP_OPTIMIZE_SPACE,
    CLONE_IS_ACTIVE_LCD_AGING,
    QUERY_DEEP_OPTIMIZE_SPACE,
    GET_DEEP_OPTIMIZE_SPACE,
    BATCH_UPDATE_METADATA_MODIFIED,
	INVOKE_ANALYSIS_TOOL,
    CANCEL_ANALYSIS_TOOL,
    SET_PHOTO_CRITICAL,
    QUERY_COMPOSITE_AUXILIARY_IMAGE_DATA,
    PAH_SYSTEM_GENERATE_UNIQUE_ID,
    PAH_VALIDATE_LIVEPHOTO_4D_LATEST_PAIR,
    ...
    CHANGE_REQUEST_SET_UPLOAD_STATUS,
    ...
    CHANGE_REQUEST_SET_DEFAULT_COVER_URI,
    CHECK_DB_AVAILABILITY,
    CHANGE_REQUEST_OPERATE_ALBUM_ATTRIBUTE,
    NOTIFY_CLONE_STATUS,
    ANALYSIS_ALBUM_GET_ATTRIBUTE,
    ALBUM_CHANGE_SET_HIDDEN_ATTRIBUTE,
    ALBUM_CHANGE_SET_ALBUM_NAME_BY_FILE,
	CONVERT_TO_ASSET,
    ASSET_CHANGE_SET_HIDDEN_ATTRIBUTE,
    ASSET_CHANGE_SET_DISPLAY_NAME_BY_FILE,
    CLONE_TO_ALBUM,
    CLONE_TO_DIR,
    CLONE_ASSETS_BY_PATH,
    MOVE_ASSETS_TO_DIR,
    MOVE_ASSETS_BY_PATH,
    ALBUM_CANCEL_CLONE_TASK,
    ALBUM_CANCEL_MOVE_TASK,
    CLONE_WITH_SHARE_ALBUM,
    PAH_MODIFY_ALBUM_DEFAULT_COVER_ORDER,
    PAH_MODIFY_HIDDEN_ALBUM_DEFAULT_COVER_ORDER,
    PAH_SET_SHARE_ALBUM_NAME,
    PAH_DELETE_SHARE_PHOTO_ALBUMS,
    PAH_ADD_SHARE_MEMBER,
    PAH_UPDATE_SHARE_MEMBER_STATUS,
    PAH_DELETE_SHARE_MEMBER,
    PAH_DELETE_MEMBER_SHARE_ALBUM,
    PAH_QUERY_SHARE_ALBUMS,
    ALBUM_GET_SHARE_ASSETS,
    ...
    INNER_RESERVE_PHOTO_URI_PERMISSION,
    INNER_RESUME_PHOTO_URI_PERMISSION,
    INNER_PREPARE_LCD,
    INNER_REMOVE_CLOUD_LCD,
    INNER_CREATE_FILE_MANAGER_ASSET,
    INNER_GET_PHOTO_URI_PERSIST_PERMISSION,
    INNER_CANCEL_PHOTO_URI_PERSIST_PERMISSION,
    INNER_CUSTOM_RESTORE_ASYNC,
    INNER_GET_CLONED_ASSET_URIS,
    ...
    CAMERA_INNER_CREATE_CAMERA_FILE_FD,
    CAMERA_INNER_SCAN_CAMERA_FILE = 60005,
    CAMERA_DEFERRED_PICTURE_INFO,
