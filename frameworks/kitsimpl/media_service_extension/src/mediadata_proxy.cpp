...
std::vector<std::string> MediaDataProxy::GetFileTypes(const Uri &uri, const std::string &mimeTypeFilter)
{
...
int MediaDataProxy::OpenFile(const Uri &uri, const std::string &mode)
{
    HILOG_INFO("%{public}s begin.", __func__);
    int fd = -1;
    MessageParcel data;
...
int MediaDataProxy::OpenRawFile(const Uri &uri, const std::string &mode)
{
    HILOG_INFO("%{public}s begin.", __func__);
    int fd = -1;
    MessageParcel data;
...
int MediaDataProxy::Insert(const Uri &uri, const NativeRdb::ValuesBucket &value)
{
    HILOG_INFO("%{public}s begin.", __func__);
    int index = -1;
    MessageParcel data;
...
int MediaDataProxy::Update(const Uri &uri, const NativeRdb::ValuesBucket &value,
...
int MediaDataProxy::Delete(const Uri &uri, const NativeRdb::DataAbilityPredicates &predicates)
{
    HILOG_INFO("%{public}s begin.", __func__);
    int index = -1;
    MessageParcel data;
...
std::shared_ptr<NativeRdb::AbsSharedResultSet> MediaDataProxy::Query(const Uri &uri,
...
std::string MediaDataProxy::GetType(const Uri &uri)
{
    HILOG_INFO("%{public}s begin.", __func__);
    std::string type;
    MessageParcel data;
...
int MediaDataProxy::BatchInsert(const Uri &uri, const std::vector<NativeRdb::ValuesBucket> &values)
{
    HILOG_INFO("%{public}s begin.", __func__);
    int ret = -1;
    MessageParcel data;
...
bool MediaDataProxy::RegisterObserver(const Uri &uri, const sptr<AAFwk::IDataAbilityObserver> &dataObserver)
{
    HILOG_INFO("%{public}s begin.", __func__);
    MessageParcel data;
    if (!data.WriteInterfaceToken(MediaDataProxy::GetDescriptor())) {
...
bool MediaDataProxy::UnregisterObserver(const Uri &uri, const sptr<AAFwk::IDataAbilityObserver> &dataObserver)
{
    HILOG_INFO("%{public}s begin.", __func__);
    MessageParcel data;
    if (!data.WriteInterfaceToken(MediaDataProxy::GetDescriptor())) {
...
bool MediaDataProxy::NotifyChange(const Uri &uri)
{
    HILOG_INFO("%{public}s begin.", __func__);
    MessageParcel data;
    if (!data.WriteInterfaceToken(MediaDataProxy::GetDescriptor())) {
...
Uri MediaDataProxy::NormalizeUri(const Uri &uri)
{
    HILOG_INFO("%{public}s begin.", __func__);
    Uri urivalue("");
    MessageParcel data;
...
Uri MediaDataProxy::DenormalizeUri(const Uri &uri)
{
    HILOG_INFO("%{public}s begin.", __func__);
    Uri urivalue("");
    MessageParcel data;
...
std::vector<std::shared_ptr<AppExecFwk::DataAbilityResult>> MediaDataProxy::ExecuteBatch(
