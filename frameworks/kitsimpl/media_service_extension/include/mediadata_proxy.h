...
#ifndef OHOS_MEDIALIBRARY_MEDIADATA_PROXY_H
#define OHOS_MEDIALIBRARY_MEDIADATA_PROXY_H
...
class MediaDataProxy : public IRemoteProxy<IMediaData> {
public:
    explicit MediaDataProxy(const sptr<IRemoteObject>& remote) : IRemoteProxy<IMediaData>(remote) {}

    virtual ~MediaDataProxy() {}
...
#endif // OHOS_MEDIALIBRARY_MEDIADATA_PROXY_H
