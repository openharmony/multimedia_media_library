...
#ifndef OHOS_MEDIALIBRARY_MEDIADATA_STUB_H
#define OHOS_MEDIALIBRARY_MEDIADATA_STUB_H
...
class MediaDataStub : public IRemoteStub<IMediaData> {
public:
    MediaDataStub();
    ~MediaDataStub();
...
#endif // OHOS_MEDIALIBRARY_MEDIADATA_STUB_H
