 ...
 */
#ifndef FRAMEWORKS_ANI_SRC_INCLUDE_REQUEST_PHOTO_URIS_READ_PERMISSION_CALLBACK_ANI_H
#define FRAMEWORKS_ANI_SRC_INCLUDE_REQUEST_PHOTO_URIS_READ_PERMISSION_CALLBACK_ANI_H
...
public:
    explicit RequestPhotoUrisReadPermissionCallback(ani_env* env, Ace::UIContent *uiContent);
