...
static const std::string PAH_CLASS_SPACE = "L@ohos/file/photoAccessHelper/photoAccessHelper/";
static const std::string UFM_CLASS_SPACE = "L@ohos/filemanagement/userFileManager/userFileManager/";
