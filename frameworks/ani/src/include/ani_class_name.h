...
static const std::string ANI_CLASS_SPACE = "L@ohos/file/photoAccessHelper/photoAccessHelper/";

static const std::string ANI_CLASS_CLOUD_ENHANCEMENT = ANI_CLASS_SPACE + "CloudEnhancementHandle;";
static const std::string ANI_CLASS_FETCH_RESULT = ANI_CLASS_SPACE + "FetchResultHandle;";
static const std::string ANI_CLASS_PHOTO_ALBUM = ANI_CLASS_SPACE + "AlbumHandle;";
static const std::string ANI_CLASS_PHOTO_ASSET = ANI_CLASS_SPACE + "PhotoAssetHandle;";
static const std::string ANI_CLASS_PHOTO_ACCESS_HELPER = ANI_CLASS_SPACE + "PhotoAccessHelperHandle;";
static const std::string ANI_CLASS_PHOTO_PROXY = ANI_CLASS_SPACE + "PhotoProxyHandle;";
static const std::string ANI_CLASS_SIZE = ANI_CLASS_SPACE + "SizeImpl;";
static const std::string ANI_CLASS_MOVING_PHOTO = ANI_CLASS_SPACE + "MovingPhotoHandle;";
static const std::string ANI_CLASS_MEDIA_ALBUM_CHANGE_REQUEST = ANI_CLASS_SPACE + "MediaAlbumChangeRequest;";
