...
static const std::map<PhotoAlbumSubType, int32_t> ANI_PHOTOALBUMSUBTYPE_INDEX_MAP = {
    ...
    {PhotoAlbumSubType::LIVEPHOTO_4D, 9},
    {PhotoAlbumSubType::SOURCE_GENERIC, 10},
    {PhotoAlbumSubType::SOURCE_GENERIC_FROM_FILE_MANAGER, 11},
    {PhotoAlbumSubType::CLASSIFY, 12},
    {PhotoAlbumSubType::GEOGRAPHY_LOCATION, 13},
    {PhotoAlbumSubType::GEOGRAPHY_CITY, 14},
    {PhotoAlbumSubType::SHOOTING_MODE, 15},
    {PhotoAlbumSubType::PORTRAIT, 16},
    {PhotoAlbumSubType::GROUP_PHOTO, 17},
    {PhotoAlbumSubType::HIGHLIGHT, 18},
    {PhotoAlbumSubType::HIGHLIGHT_SUGGESTIONS, 19},
    {PhotoAlbumSubType::ANY, 20},
};
