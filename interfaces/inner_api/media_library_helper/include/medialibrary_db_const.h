...
namespace OHOS {
namespace Media {
const int32_t MEDIA_RDB_VERSION = 102;
enum {
    VERSION_ADD_CLOUD = 2,
...
const std::string OPEN_PRIVATE_LIVE_PHOTO = "open_private_live_photo"; // MEDIA_MOVING_PHOTO_OPRN_KEYWORD=OPEN_PRIVATE_LIVE_PHOTO
