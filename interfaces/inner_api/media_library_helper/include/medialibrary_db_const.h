...
const int32_t MEDIA_RDB_VERSION = 915;
...
enum {
    ...
    VERSION_ADD_ANALYSIS_ALBUM_UPDATE_ALBUM_STATUS_TRIGGER = 414,
    VERSION_ADD_HIGHLIGHT_GROWING_TIME = 415,
    VERSION_UPDATE_TAB_COMPATIBLE_INFO = 416,
    VERSION_ADD_WATERMARK_TABLE = 417,
    VERSION_ADD_UNIQUE_ID_COLUMN_ON_PHOTO_ALBUM = 418,
    VERSION_ADD_PREFERRED_COMPATIBLE_MODE = 419,
    VERSION_ADD_LCD_AGING = 420,
    VERSION_ADD_PERSIST_PERMISSION_TABLE = 421,
    VERSION_ADD_LOCAL_ASSET_SIZE_COLUMN = 422,
    VERSION_ADD_PORTRAIT_NICKNAME_TABLE = 423,
    VERSION_ADD_ANALYSIS_CAPTION_TABLE = 424,
    VERSION_UPDATE_UNIQUE_ID_COLUMN_PHOTO_ALBUM = 425,
    VERSION_CREATE_TAB_OPERATION_LOG = 426,
    VERSION_ADD_ANALYSIS_ALBUM_EXTRA_INFO = 427,
    VERSION_ADD_FILE_HIDDEN_COLUMN = 428,
    VERSION_ADD_LAKE_TRIGGER_FILTER_FOR_FILE_MANAGER = 429,
    VERSION_ADD_FILE_MANAGER_RELATED = 430,
    VERSION_ADD_NEED_THUMBNAIL = 431,
    VERSION_ADD_ALBUM_SCENE_ID_AND_SHARE_TYPE = 432,
    VERSION_ADD_ATTACHMENT_SIZE_COLUMN = 433,
    VERSION_ADD_PHOTO_LCD_FILE_SIZE = 434,
    VERSION_ADD_TAB_COVER_RECORD_AND_INDEX = 435,
    VERSION_UPDATE_TAB_PHOTOS_EXT = 436,
    VERSION_ADD_URI_PERMISSION_FILE_TOKEN_INDEX = 437,
    VERSION_ADD_PHOTO_COMPRESSION_QUALITY = 438,
    VERSION_ADD_ANALYSIS_ALBUM_FRIEND_ID = 439,
    VERSION_ADD_OCR_TIME_SUBTYPE = 440,
    VERSION_UPDATE_TAB_PHOTOS_SHARE = 441,
    VERSION_UPDATE_TAB_ALBUM_SHARE = 442,
    VERSION_UPDATE_TAB_MEMBER_SHARE = 443,
    VERSION_ADD_MUSIC_MASTER_MODE_COLUMN = 444,
    VERSION_ADD_XT_STYLE_TEMPLATE_NAME_TYPE = 500,
    VERSION_ADD_LIVEPHOTO_4D_ALBUM = 710,
    VERSION_ADD_MAP_CODE_TABLE = 727,
    VERSION_UPDATE_POSITION_INDEX_ON_PHOTO = 900,
    VERSION_ADD_ANALYSIS_ALBUM_CONTACT_INFO = 910,
    VERSION_ADD_CLS_SCHED = 911,
    VERSION_ADD_PHOTO_C2PA_CONFIG_INFO = 912,
    VERSION_ADD_SHARED_ALBUM_FILTER_TO_ANALYSIS_TRIGGER = 913,
    VERSION_ADD_IS_SHARED_IN_DRTR = 914,
    VERSION_ADD_AFFECTIVE_COLUMN = 915,
};
enum {
