...
namespace OHOS {
namespace Media {
const int32_t MEDIA_RDB_VERSION = 101;
enum {
    VERSION_ADD_CLOUD = 2,
    ...
    VISION_UPDATE_DATA_ADDED_INDEX = 92,
    VERSION_ADD_BURST_COVER_LEVEL_AND_BURST_KEY = 93,
    VERSION_CREATE_BURSTKEY_INDEX = 94,
    VERSION_ADD_APP_URI_PERMISSION_INFO = 95,
    VERSION_UPDATE_MULTI_CROP_INFO = 96,
    VERSION_PORTRAIT_COVER_SELECTION_ADD_COLUMNS = 97,
    VERSION_UPDATE_BURST_DIRTY = 98,
    VERSION_ADD_ORIGINAL_SUBTYPE = 99,
    VERSION_MOVE_AUDIOS = 100,
    VERSION_ADD_INDEX_FOR_FILEID = 101,
};
