...
const int32_t MEDIA_RDB_VERSION = 400;
...
enum {
    ...
    VERSION_ADD_AFFECTIVE_TABLE = 367,
    VERSION_ADD_3DGS_MODE = 368,
    VERSION_UPGRADE_IDX_SCHPT_HIDDEN_TIME = 369,
    VERSION_ADD_ALBUM_ORDER_BACK_VERSION = 370,
    VERSION_CREATE_TAB_OLD_ALBUM = 371,
    VERSION_UPDATE_BURST_MODE_ALBUM_INDEX = 372,
    VERSION_UPGRADE_IDX_SCHPT_DATE_ADDED = 373,
    VERSION_ADD_IMAGE_FACE_DETAIL = 374,
    VERSION_ADD_TAB_ANALYSIS_PROGRESS_COLUMNS = 375,
    VERSION_ADD_BATCH_DOWNLOAD = 376,
    VERSION_VIDEO_MODE = 377,
    VERSION_CREATE_VIDEO_FACE_TAG_ID_INDEX = 378,
    VERSION_CREATE_TAB_CLONED_OLD_PHOTOS = 379,
    VERSION_UPDATE_VIDEO_LABLE_FACE = 380,
    VERSION_UPDATE_VIDEO_FACE_TAGID = 381,
    VERSION_UPDATE_MDIRTY_TRIGGER_FOR_STRONG_ASSOCIATION = 382,
    VERSION_ADD_IMAGE_FACE_AND_FACE_TAG_AGE_GENDER = 383,
    VERSION_ADD_QUICK_CAPTURE_AND_TIME_LAPSE = 384,
    VERSION_ADD_LAKE_COLUMN = 385,
    VERSION_FILTER_TAB_ASSET_ALBUM_OPERATION = 386,
    VERSION_PHOTO_ALBUM_ADD_UPLOAD_STATUS = 387,
    VERSION_ADD_TAB_ANALYSIS_PROGRESS_CHECK_SPACE_COLUMN = 388,
    VERSION_ADD_PET_TABLES = 389,
    VERSION_ADD_ASPECT_RATIO = 390,
    VERSION_SOURCE_ALBUM_BUNDLE_UPDATE_TRIGGER_USE_LPATH = 391,
    VERSION_ADD_PHOTO_ALBUM_HIDDEN = 392,
    VERSION_ADD_CHANGE_TIME = 393,
    VERSION_ADD_EDIT_OPERATION = 394,
    VERSION_UPDATE_MDIRTY_TRIGGER_FOR_HDR_MODE = 395,
    VERSION_ADD_AUDIO_IS_TEMP = 396,
    VERSION_ADD_ANALYSIS_UPDATE_SEARCH_TRIGGER = 397,
    VERSION_DROP_PHOTO_STATUS_FOR_SEARCH_INDEX = 398,
    VERSION_ADD_PHOTO_MOVINGPHOTO_ENHANCEMENT_TYPE = 399,
    VERSION_ADD_CRITICAL_TYPE_COLUMN_ON_PHOTOS = 400,
};
enum {
