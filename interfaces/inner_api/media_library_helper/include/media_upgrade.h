...
public:
    ...
    static const std::string CREATE_SCHPT_YEAR_COUNT_READY_INDEX EXPORT;
    static const std::string CREATE_SCHPT_MONTH_COUNT_READY_INDEX EXPORT;
    static const std::string CREATE_SCHPT_MEDIA_TYPE_COUNT_READY_INDEX EXPORT;
    static const std::string DROP_SCHPT_YEAR_COUNT_READY_INDEX EXPORT;
    static const std::string DROP_SCHPT_MONTH_COUNT_READY_INDEX EXPORT;
    static const std::string DROP_SCHPT_MEDIA_TYPE_COUNT_READY_INDEX EXPORT;
    static const std::string CREATE_SCHPT_CLOUD_ENHANCEMENT_ALBUM_INDEX EXPORT;
    static const std::string INDEX_SCHPT_ALBUM_GENERAL EXPORT;
    static const std::string INDEX_SCHPT_ALBUM EXPORT;
    static const std::string INDEX_SCTHP_PHOTO_DATEADDED EXPORT;
    static const std::string INDEX_LATITUDE EXPORT;
    static const std::string INDEX_LONGITUDE EXPORT;
    static const std::string CREATE_PHOTO_SORT_MEDIA_TYPE_DATE_ADDED_INDEX EXPORT;
    static const std::string CREATE_PHOTO_SORT_MEDIA_TYPE_DATE_TAKEN_INDEX EXPORT;
    static const std::string CREATE_PHOTO_SORT_IN_ALBUM_DATE_ADDED_INDEX EXPORT;
    static const std::string CREATE_PHOTO_SORT_IN_ALBUM_DATE_TAKEN_INDEX EXPORT;
    static const std::string CREATE_PHOTO_SORT_IN_ALBUM_SIZE_INDEX EXPORT;
    static const std::string CREATE_PHOTO_SORT_MEDIA_TYPE_SIZE_INDEX EXPORT;
    static const std::string CREATE_PHOTO_SORT_IN_ALBUM_DISPLAY_NAME_INDEX EXPORT;
    static const std::string CREATE_PHOTO_SORT_MEDIA_TYPE_DISPLAY_NAME_INDEX EXPORT;
    static const std::string CREATE_PHOTO_SHOOTING_MODE_ALBUM_GENERAL_INDEX EXPORT;
    static const std::string CREATE_PHOTO_BURST_MODE_ALBUM_INDEX EXPORT;
    static const std::string CREATE_PHOTO_FRONT_CAMERA_ALBUM_INDEX EXPORT;
    static const std::string CREATE_PHOTO_RAW_IMAGE_ALBUM_INDEX EXPORT;
    static const std::string CREATE_PHOTO_MOVING_PHOTO_ALBUM_INDEX EXPORT;
    static const std::string INDEX_QUERY_THUMBNAIL_WHITE_BLOCKS EXPORT;
