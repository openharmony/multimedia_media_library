...
const int32_t DATA_ABILITY_FAIL =             MEDIA_LIBRARY_ERR(E_COMMON_OFFSET, 1);
const int32_t DATA_ABILITY_HAS_DB_ERROR =     MEDIA_LIBRARY_ERR(E_COMMON_OFFSET, 2);
const int32_t DATA_ABILITY_HAS_FS_ERROR =     MEDIA_LIBRARY_ERR(E_COMMON_OFFSET, 3);
const int32_t DATA_ABILITY_CHECK_DIR_FAIL =   MEDIA_LIBRARY_ERR(E_COMMON_OFFSET, 4);
const int32_t DATA_ABILITY_MODIFY_DATA_FAIL = MEDIA_LIBRARY_ERR(E_COMMON_OFFSET, 5);
const int32_t DATA_ABILITY_INVALID_VALUES =   MEDIA_LIBRARY_ERR(E_COMMON_OFFSET, 6);
const int32_t DATA_ABILITY_INVALID_URI =      MEDIA_LIBRARY_ERR(E_COMMON_OFFSET, 7);
const int32_t DATA_ABILITY_INVALID_FILEID =   MEDIA_LIBRARY_ERR(E_COMMON_OFFSET, 8);
const int32_t DATA_ABILITY_INVALID_PATH =     MEDIA_LIBRARY_ERR(E_COMMON_OFFSET, 9);
const int32_t DATA_ABILITY_VIOLATION_PARAMETERS = MEDIA_LIBRARY_ERR(E_COMMON_OFFSET, 10);
const int32_t DATA_ABILITY_RDIR_FAIL =        MEDIA_LIBRARY_ERR(E_COMMON_OFFSET, 11);
...
const int32_t DATA_ABILITY_CHECK_EXTENSION_FAIL = MEDIA_LIBRARY_ERR(E_DIR_CTRL_OFFSET, 0);
const int32_t DATA_ABILITY_DELETE_DIR_FAIL =      MEDIA_LIBRARY_ERR(E_DIR_CTRL_OFFSET, 1);
const int32_t DATA_ABILITY_CHECK_MEDIATYPE_FAIL = MEDIA_LIBRARY_ERR(E_DIR_CTRL_OFFSET, 2);
const int32_t DATA_ABILITY_CHECK_ROOT_DIR_FAIL =  MEDIA_LIBRARY_ERR(E_DIR_CTRL_OFFSET, 3);
const int32_t DATA_ABILITY_CHECK_MEDIATYPE_MATCH_EXTENSION_FAIL = MEDIA_LIBRARY_ERR(E_DIR_CTRL_OFFSET, 4);
const int32_t DATA_ABILITY_FILE_NAME_INVALID =    MEDIA_LIBRARY_ERR(E_DIR_CTRL_OFFSET, 5);

// medialibary recycle, trash { 2100, 2199 }
const int32_t E_TRASH_OFFSET = 2100;
const int32_t DATA_ABILITY_RECYCLE_FILE_IS_NULL = MEDIA_LIBRARY_ERR(E_TRASH_OFFSET, 0);
const int32_t DATA_ABILITY_IS_RECYCLED =          MEDIA_LIBRARY_ERR(E_TRASH_OFFSET, 1);
...
const int32_t ERROR_MEDIA_FILE_OFFSET = 3000;
const int32_t ERROR_URI_INVALID =               MEDIA_LIBRARY_ERR(ERROR_MEDIA_FILE_OFFSET, 0);
const int32_t ERROR_DISTIBUTED_URI_NO_SUPPORT = MEDIA_LIBRARY_ERR(ERROR_MEDIA_FILE_OFFSET, 1);
const int32_t ERROR_URI_IS_NOT_ALBUM =          MEDIA_LIBRARY_ERR(ERROR_MEDIA_FILE_OFFSET, 2);
const int32_t ERROR_URI_IS_NOT_FILE =           MEDIA_LIBRARY_ERR(ERROR_MEDIA_FILE_OFFSET, 3);
const int32_t ERROR_TWO_URI_ARE_THE_SAME =      MEDIA_LIBRARY_ERR(ERROR_MEDIA_FILE_OFFSET, 4);
const int32_t ERROR_OPENFILE_INVALID_FLAG =     MEDIA_LIBRARY_ERR(ERROR_MEDIA_FILE_OFFSET, 5);
const int32_t ERROR_INVAVLID_DISPLAY_NAME =     MEDIA_LIBRARY_ERR(ERROR_MEDIA_FILE_OFFSET, 6);
const int32_t ERROR_TARGET_FILE_EXIST =         MEDIA_LIBRARY_ERR(ERROR_MEDIA_FILE_OFFSET, 7);
const int32_t ERROR_DENIED_MOVE =               MEDIA_LIBRARY_ERR(ERROR_MEDIA_FILE_OFFSET, 8);
const int32_t ERROR_UPDATE_DB_FAIL =            MEDIA_LIBRARY_ERR(ERROR_MEDIA_FILE_OFFSET, 9);
const int32_t ERROR_DENIED_RENAME =             MEDIA_LIBRARY_ERR(ERROR_MEDIA_FILE_OFFSET, 10);
