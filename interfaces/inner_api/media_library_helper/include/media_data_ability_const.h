...
const int32_t E_TARGET_FILE_EXIST =         MEDIA_LIBRARY_ERR(E_MEDIA_FILE_OFFSET, 7);
const int32_t E_DENIED_MOVE =               MEDIA_LIBRARY_ERR(E_MEDIA_FILE_OFFSET, 8);
const int32_t E_UPDATE_DB_FAIL =            MEDIA_LIBRARY_ERR(E_MEDIA_FILE_OFFSET, 9);
const int32_t E_DENIED_RENAME =             MEDIA_LIBRARY_ERR(E_MEDIA_FILE_OFFSET, 10);
