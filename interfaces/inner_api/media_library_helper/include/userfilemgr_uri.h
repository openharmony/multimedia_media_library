...
const std::string MEDIA_FILEOPRN_OPEN_DEBUG_DB = "open_debug_db";
...
const std::string PAH_ANA_VIDEO_TOTAL = "phaccess_ana_video_total_operation";
...
const std::string PAH_QUERY_ANA_VIDEO_TOTAL = MEDIALIBRARY_DATA_URI + "/" + PAH_ANA_VIDEO_TOTAL + "/" + OPRN_QUERY;
