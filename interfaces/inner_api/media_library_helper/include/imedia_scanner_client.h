...
public:
     ...
     *
     * @param scanDirPath Valid path to a directory {/storage/cloud/files}
     ...
     *
     * @param scanFilePath Valid path to a file along with filename{/storage/cloud/files/sample.mp3}
     * @param appCb Callback object to be passed along with request
