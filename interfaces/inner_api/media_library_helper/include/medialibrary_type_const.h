...
const std::string MEDIA_BACKUP_DIR = ROOT_MEDIA_DIR + ".backup/";
const std::string MEDIA_META_DIR = ROOT_MEDIA_DIR + ".meta/";
const std::string MEDIA_AUDIO_DIR = ROOT_MEDIA_DIR + "Audio/";
const std::string MEDIA_AUDIOS_DIR = ROOT_MEDIA_DIR + "Audios/";
const std::string MEDIA_CAMERA_DIR = ROOT_MEDIA_DIR + "Camera/";
const std::string MEDIA_PICTURES_DIR = ROOT_MEDIA_DIR + "Pictures/";
const std::string MEDIA_VIDEO_DIR = ROOT_MEDIA_DIR + "Videos/";
const std::string MEDIA_CUSTOM_RESTORE_DIR = ROOT_MEDIA_DIR + "custom_restore/";
...
const std::string REAL_PATH_PREFIX = "/data/service/el2/";
const std::string REAL_PATH_SUFFIX = "/hmdfs/account/files/";
