 ...
 */
#ifndef INTERFACES_KITS_JS_MEDIALIBRARY_INCLUDE_SHORT_TERM_CALLBACK_H
#define INTERFACES_KITS_JS_MEDIALIBRARY_INCLUDE_SHORT_TERM_CALLBACK_H
...
public:
    explicit ShortTermCallback(napi_env env, Ace::UIContent *uiContent);
