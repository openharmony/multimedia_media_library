...
#ifndef INTERFACES_KITS_JS_MEDIALIBRARY_INCLUDE_MOVING_PHOTO_NAPI_SENDABLE_H
#define INTERFACES_KITS_JS_MEDIALIBRARY_INCLUDE_MOVING_PHOTO_NAPI_SENDABLE_H
...
class SendableMovingPhotoNapi {
public:
    SendableMovingPhotoNapi(const std::string& photoUri) : photoUri_(photoUri) {};
    ~SendableMovingPhotoNapi() = default;
...
struct SendableMovingPhotoAsyncContext : public NapiError {
