...
#define MLOG_TAG "StartThumbnailCreationTaskReqBodyVo"
...
bool StartThumbnailCreationTaskReqBody::Unmarshalling(MessageParcel &parcel)
{
...
bool StartThumbnailCreationTaskReqBody::Marshalling(MessageParcel &parcel) const
{
