...
#define MLOG_TAG "MediaCloneAssetVo"
...
using namespace std;
bool CloneAssetReqBody::Unmarshalling(MessageParcel &parcel)
{
...
bool CloneAssetReqBody::Marshalling(MessageParcel &parcel) const
{
