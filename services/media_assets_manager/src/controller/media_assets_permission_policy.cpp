...
static std::unordered_map<uint32_t, std::vector<std::vector<PermissionType>>> mediaAssetsPermissionPolicy = {
    ...
    {static_cast<uint32_t>(MediaLibraryBusinessCode::ACQUIRE_DEBUG_DATABASE), {{SYSTEMAPI_PERM, READ_PERM}}},
    {static_cast<uint32_t>(MediaLibraryBusinessCode::RELEASE_DEBUG_DATABASE), {{SYSTEMAPI_PERM, READ_PERM}}},
};
