...
static std::unordered_map<uint32_t, std::vector<std::vector<PermissionType>>> mediaAssetsPermissionPolicy = {
    ...
    {static_cast<uint32_t>(MediaLibraryBusinessCode::ASSET_CHANGE_SET_FAVORITE), {{WRITE_PERM}}},
    ...
    {static_cast<uint32_t>(MediaLibraryBusinessCode::PAH_SYSTEM_BATCH_SET_FAVORITE), {{WRITE_PERM}}},
    ...
    {static_cast<uint32_t>(MediaLibraryBusinessCode::INNER_CUSTOM_RESTORE_ASYNC), {{WRITE_PERM}}},
    ...
    {static_cast<uint32_t>(MediaLibraryBusinessCode::ASSET_CHANGE_SET_COMPOSITE_DISPLAY_MODE),
        {{SYSTEMAPI_PERM, WRITE_PERM}}},
    {static_cast<uint32_t>(MediaLibraryBusinessCode::SLOW_MOTION_TRANSCODE), {{READ_PERM}}},
    {static_cast<uint32_t>(MediaLibraryBusinessCode::SLOW_MOTION_TRANSCODE_PROGRESS), {{READ_PERM}}},
	{static_cast<uint32_t>(MediaLibraryBusinessCode::CANCEL_SLOW_MOTION_TRANSCODE), {{READ_PERM}}},
    ...
    {static_cast<uint32_t>(MediaLibraryBusinessCode::GET_PREFERRED_COMPATIBLE_MODE), {{SYSTEMAPI_PERM}}},
    ...
    {static_cast<uint32_t>(MediaLibraryBusinessCode::CLONE_WITH_SHARE_ALBUM), {{SYSTEMAPI_PERM, WRITE_PERM}}},
