...
const std::unordered_map<GenThumbScene, std::string> GEN_THUMB_SCENE_NAME = {
    ...
    { GenThumbScene::FILE_MANAGER_THUMB, "FILE_MANAGER_THUMB" },
    { GenThumbScene::FILE_MANAGER_THUMB_RESTORE, "FILE_MANAGER_THUMB_RESTORE" },
    ...
    { GenThumbScene::CLOUD_DOWNLOAD_THM_SHORT_SIDE_SATISFIED, "CLOUD_DOWNLOAD_THM_SHORT_SIDE_SATISFIED" },
    { GenThumbScene::CLOUD_DOWNLOAD_THM_SHORT_SIDE_NOT_SATISFIED, "CLOUD_DOWNLOAD_THM_SHORT_SIDE_NOT_SATISFIED" },
