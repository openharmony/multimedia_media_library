 ...
 */
#ifndef OHOS_MEDIA_LAKE_SCAN_POLICY_H
#define OHOS_MEDIA_LAKE_SCAN_POLICY_H

#include "i_scan_policy.h"

namespace OHOS::Media {
class LakeScanPolicy final : public IScanPolicy {
public:
...
#endif // OHOS_MEDIA_LAKE_SCAN_POLICY_H