 ...
 */
#ifndef MEDIA_LIBRARY_MEDIA_FILE_MONITOR_RDB_UTILS_H
#define MEDIA_LIBRARY_MEDIA_FILE_MONITOR_RDB_UTILS_H
...
struct LakeMonitorQueryResultData {
    ...
    int32_t position = static_cast<int32_t>(PhotoPositionType::INVALID);
};
...
class EXPORT MediaFileMonitorRdbUtils {
public:
...
#endif // MEDIA_LIBRARY_MEDIA_FILE_MONITOR_RDB_UTILS_H