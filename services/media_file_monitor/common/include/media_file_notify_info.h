 ...
 */
#ifndef MEDIA_FILE_NOTIFY_INFO_H
#define MEDIA_FILE_NOTIFY_INFO_H
...
struct MediaNotifyInfo {
    ...
    FileNotifyPathType pathType { FileNotifyPathType::UNDEFINED };
};
}
}

#endif // MEDIA_FILE_NOTIFY_INFO_H