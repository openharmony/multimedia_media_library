...
namespace OHOS::Media {
        ...
        realseFileMonitorProxyFunc_(nullptr)
    {
        ...
        CHECK_AND_RETURN_LOG(handler_ != nullptr, "Not find file_monitor_ipc_interface lib.");
        ...
        if (createFileMonitorProxyFunc_ == nullptr || realseFileMonitorProxyFunc_ == nullptr) {
            MEDIA_ERR_LOG("Not find CreateFileMonitorProxy or RealseFileMonitorProxy func: %{public}s", dlerror());
    ...
    FileMonitorService::FileMonitorProxy* FileMonitorWrapper::CreateFileMonitorProxy(int32_t tableID)
    {
        CHECK_AND_RETURN_RET_LOG(createFileMonitorProxyFunc_ != nullptr, nullptr,
            "CreateFileMonitorProxy failed, func is nullptr");
    ...
    {
        CHECK_AND_RETURN_LOG(realseFileMonitorProxyFunc_ != nullptr, "RealseFileMonitorProxy failed, func is nullptr");
