...
public:
    ...
    int32_t ProcessNotification(const MediaNotifyInfo &notifyInfo);
...
protected:
    ...
    void InitializeRdb();
    void RegisterLakeProcessors(class MediaProcessorRegistry& registry);
    void RegisterFileManagerProcessors(class MediaProcessorRegistry& registry);
