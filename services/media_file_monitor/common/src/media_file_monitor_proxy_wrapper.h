...
public:
    ...
    {
        MEDIA_INFO_LOG("enter file monitor proxy wrapper, care type: 0x%{public}llx",
        ...
        CHECK_AND_RETURN_LOG(fileMonitorProxy_ != nullptr, "create file monitor proxy failed");
    }
