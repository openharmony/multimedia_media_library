...
#ifndef OHOS_MEDIA_PORTRAIT_CONTACT_INFO_HANDLER_H
#define OHOS_MEDIA_PORTRAIT_CONTACT_INFO_HANDLER_H
...
class PortraitContactInfoHandler {
public:
...
#endif // OHOS_MEDIA_PORTRAIT_CONTACT_INFO_HANDLER_H