...
#ifndef OHOS_MEDIA_PORTRAIT_IS_REMOVED_HANDLER_H
#define OHOS_MEDIA_PORTRAIT_IS_REMOVED_HANDLER_H
...
class PortraitIsRemovedHandler {
public:
...
#endif // OHOS_MEDIA_PORTRAIT_IS_REMOVED_HANDLER_H
