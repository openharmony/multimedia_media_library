...
bool GetClonedAlbumUrisReqBody::Unmarshalling(MessageParcel &parcel)
{
...
bool GetClonedAlbumUrisReqBody::Marshalling(MessageParcel &parcel) const
{
...
bool GetClonedAlbumUrisRespBody::Unmarshalling(MessageParcel &parcel)
{
...
bool GetClonedAlbumUrisRespBody::Marshalling(MessageParcel &parcel) const
{
