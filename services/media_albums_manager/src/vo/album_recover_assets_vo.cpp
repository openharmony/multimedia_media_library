...
#define MLOG_TAG "MediaRecoverAssetsVo"
...
using namespace std;
bool AlbumRecoverAssetsReqBody::Unmarshalling(MessageParcel &parcel)
{
...
bool AlbumRecoverAssetsReqBody::Marshalling(MessageParcel &parcel) const
{
