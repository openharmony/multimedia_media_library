...
#define MLOG_TAG "MediaChangeRequestSetCoverUriVo"
...
using namespace std;
bool ChangeRequestSetCoverUriReqBody::Unmarshalling(MessageParcel &parcel)
{
...
bool ChangeRequestSetCoverUriReqBody::Marshalling(MessageParcel &parcel) const
{
