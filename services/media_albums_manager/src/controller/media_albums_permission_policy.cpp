...
static std::unordered_map<uint32_t, std::vector<std::vector<PermissionType>>> mediaAlbumsPermissionPolicy = {
    ...
    {static_cast<uint32_t>(MediaLibraryBusinessCode::CHANGE_REQUEST_SET_RELATIONSHIP), {{WRITE_PERM}}},
    {static_cast<uint32_t>(MediaLibraryBusinessCode::PAH_GET_RELATIONSHIP), {{READ_PERM}}},
