...
public:
    ...
    virtual int32_t Delete(MediaLibraryCommand &cmd, int32_t &deletedRows);
    virtual int32_t Delete(const NativeRdb::AbsRdbPredicates &predicates, int32_t &deletedRows);
