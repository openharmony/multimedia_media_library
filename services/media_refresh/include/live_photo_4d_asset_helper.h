...
#ifndef OHOS_MEDIALIBRARY_LIVE_PHOTO_4D_ASSET_HELPER_H
#define OHOS_MEDIALIBRARY_LIVE_PHOTO_4D_ASSET_HELPER_H

#include "album_asset_helper.h"

namespace OHOS {
namespace Media::AccurateRefresh {
class LivePhoto4DAssetHelper {
public:
    // 系统资产
...
private:
    static bool IsTypeStatusLivePhoto4D(const PhotoAssetChangeInfo &assetInfo);
};
