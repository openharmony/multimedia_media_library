...
const int32_t ACCURATE_REFRESH_RDB_TRANS_GEN_ERR = ACCURATE_REFRESH_RDB_BASE + 3;

const int32_t ACCURATE_REFRESH_RDB_TRIGGER_ERR = ACCURATE_REFRESH_RDB_BASE + 4;
