...
#ifndef REFRESH_TOTAL_SCORE_H
#define REFRESH_TOTAL_SCORE_H
...
private:
    void CalculateCloneTotalScore();
    void MergeWithDestinationTotalScore();
