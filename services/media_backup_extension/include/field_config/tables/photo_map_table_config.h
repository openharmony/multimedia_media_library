...
#ifndef OHOS_MEDIA_PHOTO_MAP_TABLE_CONFIG_H
#define OHOS_MEDIA_PHOTO_MAP_TABLE_CONFIG_H
...
inline CloneTableMeta BuildPhotoMapTableMeta()
{
    using FP = FieldPolicy;
    using FT = CloneFieldType;
    CloneTableMeta t{ PhotoMap::TABLE, "" };
    t.fields = {
...
#endif // OHOS_MEDIA_PHOTO_MAP_TABLE_CONFIG_H
