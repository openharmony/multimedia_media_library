...
#define MLOG_TAG "MediaBgTask_UpdateInvalidMimeTypePrecessor"
...
int32_t UpdateInvalidMimeTypePrecessor::Start(const std::string &taskExtra)
{
    MEDIA_INFO_LOG("Start begin");
    ffrt::submit([this]() {
        UpdateInvalidMimeType();
...
int32_t UpdateInvalidMimeTypePrecessor::Stop(const std::string &taskExtra)
{
    taskStop_ = true;
    return E_OK;
}

int32_t UpdateInvalidMimeTypePrecessor::GetCountOfAllAssets(int32_t &assetsCount)
{
...
int32_t UpdateInvalidMimeTypePrecessor::UpdateInvalidMimeType()
{
...
int32_t UpdateInvalidMimeTypePrecessor::HandleUpdateInvalidMimeType(
