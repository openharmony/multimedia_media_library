...
#define MLOG_TAG "MediaBgTask_RepairHistoryDirtyDataProcessor"
...
namespace OHOS {
namespace Media {
int32_t RepairHistoryDirtyDataProcessor::Start(const std::string &taskExtra)
{
...
int32_t RepairHistoryDirtyDataProcessor::Stop(const std::string &taskExtra)
{
