...
public:
    ...
    EXPORT static bool HasUpgraded(int32_t version, bool isSync, const std::string& path = RDB_UPGRADE_EVENT);
    EXPORT static void SetUpgradeStatus(int32_t version, bool isSync, const std::string& path = RDB_UPGRADE_EVENT);
