...
#ifndef OHOS_FILES_TABLE_STRATEGY_H
#define OHOS_FILES_TABLE_STRATEGY_H
...
namespace OHOS {
namespace Media {
class FilesTableStrategy final : public RdbTableStrategy {
public:
    FilesTableStrategy() = default;
    ~FilesTableStrategy() override = default;
...
#endif // OHOS_FILES_TABLE_STRATEGY_H