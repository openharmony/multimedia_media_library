...
enum AssetRefreshOperation {
    ...
    // 普通资产
    ASSET_OPERATION_ADD = ASSET_OPERATION_ADD_BASE,
    ASSET_OPERATION_ADD_HIDDEN, // 云同步
    ASSET_OPERATION_ADD_TRASH, // 回收站
 
    ASSET_OPERATION_REMOVE = ASSET_OPERATION_REMOVE_BASE,

    ASSET_OPERATION_REMOVE_HIDDEN,
    ASSET_OPERATION_REMOVE_TRASH,

    ASSET_OPERATION_UPDATE_NORMAL = ASSET_OPERATION_UPDATE_BASE,
    ASSET_OPERATION_UPDATE_ADD_NORMAL,
    ASSET_OPERATION_UPDATE_REMOVE_NORMAL,
    
    ASSET_OPERATION_UPDATE_HIDDEN,
    ASSET_OPERATION_UPDATE_ADD_HIDDEN,
    ASSET_OPERATION_UPDATE_REMOVE_HIDDEN,
    
    ASSET_OPERATION_UPDATE_TRASH,
    ASSET_OPERATION_UPDATE_ADD_TRASH,
    ASSET_OPERATION_UPDATE_REMOVE_TRASH,
	
    ASSET_OPERATION_TRASH,
