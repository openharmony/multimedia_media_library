...
const int32_t ASSET_ANALYSIS_ONLY = 0x01000000;
const int32_t ASSET_OPERATION_ANALYSIS_BASE = 0x300000;
const int32_t ASSET_OPERATION_SHARE_BASE = 0x400000;
enum AssetRefreshOperation {
    ...
    ASSET_OPERATION_ADD_WITH_ANALYSIS = ASSET_OPERATION_ANALYSIS_BASE | ASSET_OPERATION_ADD,
    ASSET_OPERATION_REMOVE_WITH_ANALYSIS = ASSET_OPERATION_ANALYSIS_BASE | ASSET_OPERATION_REMOVE,
    ASSET_OPERATION_UPDATE_WITH_ANALYSIS = ASSET_OPERATION_ANALYSIS_BASE | ASSET_OPERATION_UPDATE_BASE | 0x1,
    ANALYSIS_ASSET_OPERATION_ADD = ASSET_OPERATION_ANALYSIS_BASE | ASSET_OPERATION_ADD | ASSET_ANALYSIS_ONLY,
    ANALYSIS_ASSET_OPERATION_REMOVE = ASSET_OPERATION_ANALYSIS_BASE | ASSET_OPERATION_REMOVE | ASSET_ANALYSIS_ONLY,
    ANALYSIS_ASSET_OPERATION_RECHECK = ASSET_OPERATION_ANALYSIS_BASE | ASSET_OPERATION_RECHECK | ASSET_ANALYSIS_ONLY,

    /* 共享相册 */
    ASSET_OPERATION_ADD_SHARE = ASSET_OPERATION_SHARE_BASE | ASSET_OPERATION_ADD,
    ASSET_OPERATION_REMOVE_SHARE = ASSET_OPERATION_SHARE_BASE | ASSET_OPERATION_REMOVE,
    ASSET_OPERATION_UPDATE_SHARE = ASSET_OPERATION_SHARE_BASE | ASSET_OPERATION_UPDATE_NORMAL,
};
...
enum AlbumRefreshOperation {
    ...
    ANALYSIS_ALBUM_OPERATION_ADD,
    ANALYSIS_ALBUM_OPERATION_REMOVE,
    ANALYSIS_ALBUM_OPERATION_UPDATE,
    ANALYSIS_ALBUM_OPERATION_RECHECK,
    ALBUM_OPERATION_ADD_SHARE,
    ALBUM_OPERATION_REMOVE_SHARE,
    ALBUM_OPERATION_UPDATE_SHARE,
};
