...
#ifndef OHOS_MEDIA_CLOUD_SYNC_CLOUD_MEDIA_COMMON_DAO_H
#define OHOS_MEDIA_CLOUD_SYNC_CLOUD_MEDIA_COMMON_DAO_H
...
class CloudMediaCommonDao {
public:
    CloudMediaCommonDao() = default;
    ~CloudMediaCommonDao() = default;
