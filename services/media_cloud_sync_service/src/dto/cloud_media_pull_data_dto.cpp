...
void CloudMediaPullDataDto::GetBasicInfo(std::stringstream &ss)
{
    ss << "\"cloudId\": \"" << cloudId << "\","
       ...
       << "\"basicSize\": " << basicSize << ","
       << "\"basicDisplayName\": \"" << basicDisplayName << "\","
       ...
       << "\"attributesDuration\": " << attributesDuration << ","
...
void CloudMediaPullDataDto::GetPropertiesInfo(std::stringstream &ss)
{
    ss << "\"hasProperties\": " << std::to_string(hasProperties) << ","
       << "\"propertiesSourceFileName\": \"" << propertiesSourceFileName << "\","
       << "\"propertiesSourcePath\": \"" << propertiesSourcePath << "\","
       << "\"propertiesDuration\": " << propertiesDuration << ","
